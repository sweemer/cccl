...
template <class _Tp>
inline _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 _LIBCUDACXX_NO_CFI _LIBCUDACXX_INLINE_VISIBILITY _Tp*
...
template <class _Tp>
inline _LIBCUDACXX_NO_CFI _LIBCUDACXX_INLINE_VISIBILITY _Tp*
addressof(_Tp& __x) noexcept
{
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __strong _Tp*
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __weak _Tp*
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __autoreleasing _Tp*
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __unsafe_unretained _Tp*
