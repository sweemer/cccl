...
public:
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 static pointer
...
_LIBCUDACXX_INLINE_VISIBILITY constexpr __decay_t<decltype(__to_address_helper<_Pointer>::__call(
