...
union __expected_union_t {
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_union_t(__expected_construct_from_invoke_tag, in_place_t,
      _Fun&& __fun,
  ...
  template <class _Fun, class... _Args>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_union_t(__expected_construct_from_invoke_tag, unexpect_t,
      _Fun&& __fun,
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 ~__expected_union_t() {}
...
template <class _Tp, class _Err, bool = _LIBCUDACXX_TRAIT(is_trivially_destructible, _Tp),
...
struct __expected_destruct<_Tp, _Err, false, false>
{
  ...
  template <class _Fun, class... _Args>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_destruct(__expected_construct_from_invoke_tag, in_place_t,
      _Fun&& __fun,
      _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Tp, invoke_result_t<_Fun, _Args...>))
      : __union_(__expected_construct_from_invoke_tag{}, in_place, _CUDA_VSTD::forward<_Fun>(__fun),
          _CUDA_VSTD::forward<_Args>(__args)...)
      , __has_val_(true)
  {}

  template <class _Fun, class... _Args>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_destruct(__expected_construct_from_invoke_tag, unexpect_t,
      _Fun&& __fun,
      _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err, invoke_result_t<_Fun, _Args...>))
      : __union_(__expected_construct_from_invoke_tag{}, unexpect, _CUDA_VSTD::forward<_Fun>(__fun),
          _CUDA_VSTD::forward<_Args>(__args)...)
      , __has_val_(false)
  {}

  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 ~__expected_destruct()
  {
    if (__has_val_) {
...
#  if defined(_LIBCUDACXX_COMPILER_NVRTC) \
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_storage(_Args&&... __args) noexcept(
...
#  endif // !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3
  ...
  static _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void
...
#  if defined(_LIBCUDACXX_COMPILER_NVRTC) \
  ...
  template <class... _Args, __enable_if_t<_LIBCUDACXX_TRAIT(is_constructible, __base, _Args...), int> = 0>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_copy(_Args&&... __args) noexcept(
      noexcept(__base(_CUDA_VSTD::declval<_Args>()...)))
      : __base(_CUDA_VSTD::forward<_Args>(__args)...)
  {}
#  else // ^^^ _LIBCUDACXX_COMPILER_NVRTC || nvcc < 11.3 ^^^ / vvv !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3 vvv
...
#  endif // !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3
  ...
  __expected_copy(const __expected_copy& __other) noexcept(
...
#  if defined(_LIBCUDACXX_COMPILER_NVRTC) \
  ...
  template <class... _Args, __enable_if_t<_LIBCUDACXX_TRAIT(is_constructible, __base, _Args...), int> = 0>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_move(_Args&&... __args) noexcept(
      noexcept(__base(_CUDA_VSTD::declval<_Args>()...)))
      : __base(_CUDA_VSTD::forward<_Args>(__args)...)
  {}
#  else // ^^^ _LIBCUDACXX_COMPILER_NVRTC || nvcc < 11.3 ^^^ / vvv !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3 vvv
...
#  endif // !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17
  __expected_move(__expected_move&& __other) noexcept(
...
#  if defined(_LIBCUDACXX_COMPILER_NVRTC) \
  ...
  template <class... _Args, __enable_if_t<_LIBCUDACXX_TRAIT(is_constructible, __base, _Args...), int> = 0>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_copy_assign(_Args&&... __args) noexcept(
      noexcept(__base(_CUDA_VSTD::declval<_Args>()...)))
      : __base(_CUDA_VSTD::forward<_Args>(__args)...)
  {}
#  else // ^^^ _LIBCUDACXX_COMPILER_NVRTC || nvcc < 11.3 ^^^ / vvv !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3 vvv
...
#  endif // !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __expected_copy_assign&
...
#  if defined(_LIBCUDACXX_COMPILER_NVRTC) \
  ...
  template <class... _Args, __enable_if_t<_LIBCUDACXX_TRAIT(is_constructible, __base, _Args...), int> = 0>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __expected_move_assign(_Args&&... __args) noexcept(
      noexcept(__base(_CUDA_VSTD::declval<_Args>()...)))
      : __base(_CUDA_VSTD::forward<_Args>(__args)...)
  {}
#  else // ^^^ _LIBCUDACXX_COMPILER_NVRTC || nvcc < 11.3 ^^^ / vvv !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3 vvv
...
#  endif // !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __expected_move_assign&
      ...
      && _LIBCUDACXX_TRAIT(is_nothrow_move_constructible, _Err)) // strengthened
  {
    if (this->__has_val_ && __other.__has_val_) {
      ...
      this->__reinit_expected(
          this->__union_.__unex_, this->__union_.__val_, _CUDA_VSTD::move(__other.__union_.__unex_));
      this->__has_val_ = false;
    } else if (!this->__has_val_ && __other.__has_val_) {
...
#  endif // !_LIBCUDACXX_COMPILER_NVRTC || nvcc >= 11.3
  ...
  static _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void
  __swap_val_unex_impl(__expected_storage& __with_val, __expected_storage& __with_err) noexcept(
      _LIBCUDACXX_TRAIT(is_nothrow_move_constructible, _Err))
  {
    _LIBCUDACXX_CONSTRUCT_AT(__with_val.__union_.__unex_, _CUDA_VSTD::move(__with_err.__union_.__unex_));
    _CUDA_VSTD::__destroy_at(_CUDA_VSTD::addressof(__with_err.__union_.__unex_));
...
template <class _Err>
using __expected_void_sfinae_ctor_base_t = __sfinae_ctor_base< _LIBCUDACXX_TRAIT(is_copy_constructible, _Err),
