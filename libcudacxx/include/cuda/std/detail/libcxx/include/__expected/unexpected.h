...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit unexpected(in_place_t, initializer_list<_Up> __il,
  ...
  // [expected.un.obs]
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_NODISCARD_ATTRIBUTE constexpr const _Err&
  error() const& noexcept
  {
    return __unex_;
  }

  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_NODISCARD_ATTRIBUTE constexpr _Err&
  error() & noexcept
  {
    return __unex_;
  }
  ...
  friend _LIBCUDACXX_INLINE_VISIBILITY constexpr _LIBCUDACXX_NODISCARD_EXT bool
  operator==(const unexpected& __lhs, const unexpected<_UErr>& __rhs) noexcept(
...
#  if _LIBCUDACXX_STD_VER < 20
  template <class _UErr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_NODISCARD_EXT friend constexpr bool
  operator!=(const unexpected& __lhs, const unexpected<_UErr>& __rhs) noexcept(
      noexcept(static_cast<bool>(__lhs.error() != __rhs.error())))
  {
    return __lhs.error() != __rhs.error();
