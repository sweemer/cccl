...
__throw_bad_expected_access(_Arg&& __arg)
{
#  ifndef _LIBCUDACXX_NO_EXCEPTIONS
...
private:
  ...
  using __can_convert = _And< is_constructible<_Tp, _UfQual>, is_constructible<_Err, _OtherErrQual>,
      _Not<is_constructible<_Tp, expected<_Up, _OtherErr>&>>, _Not<is_constructible<_Tp, expected<_Up, _OtherErr>>>,
      _Not<is_constructible<_Tp, const expected<_Up, _OtherErr>&>>,
      _Not<is_constructible<_Tp, const expected<_Up, _OtherErr>>>, _Not<is_convertible<expected<_Up, _OtherErr>&, _Tp>>,
      _Not<is_convertible<expected<_Up, _OtherErr>&&, _Tp>>, _Not<is_convertible<const expected<_Up, _OtherErr>&, _Tp>>,
...
public:
  ...
  _LIBCUDACXX_REQUIRES(
      __can_convert<_Up, _OtherErr, const _Up&, const _OtherErr&>::value _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(
          is_convertible, const _Up&, _Tp) _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(is_convertible, const _OtherErr&, _Err))
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
      _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 explicit expected(const expected<_Up, _OtherErr>& __other) noexcept(
          _LIBCUDACXX_TRAIT(is_nothrow_constructible, _Tp, const _Up&)
          && _LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err, const _OtherErr&)) // strengthened
      : __base(__other.__has_val_)
  {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 //
      explicit expected(expected<_Up, _OtherErr>&& __other) noexcept(
          _LIBCUDACXX_TRAIT(is_nothrow_constructible, _Tp, _Up)
          && _LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err, _OtherErr)) // strengthened
      : __base(__other.__has_val_)
  {
  ...
  _LIBCUDACXX_REQUIRES((!_LIBCUDACXX_TRAIT(is_same, __remove_cvref_t<_Up>, in_place_t)) _LIBCUDACXX_AND(
      !_LIBCUDACXX_TRAIT(is_same, expected, __remove_cvref_t<_Up>))
          _LIBCUDACXX_AND(!__unexpected::__is_unexpected<__remove_cvref_t<_Up>>) _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(
              is_constructible, _Tp, _Up) _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(is_convertible, _Up, _Tp))
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr expected(
      const unexpected<_OtherErr>& __unex) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err,
      const _OtherErr&)) // strengthened
  ...
  _LIBCUDACXX_REQUIRES(_LIBCUDACXX_TRAIT(is_constructible, _Err, _OtherErr)
          _LIBCUDACXX_AND(!_LIBCUDACXX_TRAIT(is_convertible, _OtherErr, _Err)))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit expected(
      unexpected<_OtherErr>&& __unex) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err,
      _OtherErr)) // strengthened
      : __base(unexpect, _CUDA_VSTD::move(__unex.error()))
  {}

  _LIBCUDACXX_TEMPLATE(class... _Args)
  _LIBCUDACXX_REQUIRES(_LIBCUDACXX_TRAIT(is_constructible, _Tp, _Args...))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit expected(in_place_t,
      _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Tp, _Args...)) // strengthened
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit expected(
      in_place_t, initializer_list<_Up> __il, _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible,
      _Tp, initializer_list<_Up>&, _Args...)) // strengthened
      : __base(in_place, __il, _CUDA_VSTD::forward<_Args>(__args)...)
  {}

  _LIBCUDACXX_TEMPLATE(class... _Args)
  _LIBCUDACXX_REQUIRES(_LIBCUDACXX_TRAIT(is_constructible, _Err, _Args...))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit expected(unexpect_t,
      _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err, _Args...)) // strengthened
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit expected(
      unexpect_t, initializer_list<_Up> __il, _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible,
      _Err, initializer_list<_Up>&, _Args...)) // strengthened
      : __base(unexpect, __il, _CUDA_VSTD::forward<_Args>(__args)...)
  {}

private:
  template <class _Fun, class... _Args>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr expected(__expected_construct_from_invoke_tag,
      in_place_t, _Fun&& __fun,
      _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Tp, invoke_result_t<_Fun, _Args...>))
      : __base(__expected_construct_from_invoke_tag{}, in_place, _CUDA_VSTD::forward<_Fun>(__fun),
          _CUDA_VSTD::forward<_Args>(__args)...)
  {}

  template <class _Fun, class... _Args>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr expected(__expected_construct_from_invoke_tag,
      unexpect_t, _Fun&& __fun,
      _Args&&... __args) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err, invoke_result_t<_Fun, _Args...>))
      : __base(__expected_construct_from_invoke_tag{}, unexpect, _CUDA_VSTD::forward<_Fun>(__fun),
          _CUDA_VSTD::forward<_Args>(__args)...)
  {}
...
public:
  ...
  _LIBCUDACXX_REQUIRES((!_LIBCUDACXX_TRAIT(is_same, expected, __remove_cvref_t<_Up>)) _LIBCUDACXX_AND(
      !__unexpected::__is_unexpected<__remove_cvref_t<_Up>>) _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(is_constructible, _Tp,
      _Up) _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(is_assignable, _Tp&, _Up)
          _LIBCUDACXX_AND(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Tp, _Up)
                          || _LIBCUDACXX_TRAIT(is_nothrow_move_constructible, _Tp)
                          || _LIBCUDACXX_TRAIT(is_nothrow_move_constructible, _Err)))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 expected&
  operator=(_Up&& __v)
  {
    if (this->__has_val_) {
...
private:
  ...
  static constexpr bool __can_assign_from_unexpected =
      _And< is_constructible<_Err, _OtherErrQual>, is_assignable<_Err&, _OtherErrQual>,
          _Lazy<_Or, is_nothrow_constructible<_Err, _OtherErrQual>, is_nothrow_move_constructible<_Tp>,
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 _Tp&
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void
  ...
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 auto
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr const _Tp*
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr _Tp*
  operator->() noexcept
  {
    _LIBCUDACXX_ASSERT(this->__has_val_, "expected::operator-> requires the expected to contain a value");
    return _CUDA_VSTD::addressof(this->__union_.__val_);
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr const _Err&
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr _Err&
  error() & noexcept
  {
    _LIBCUDACXX_ASSERT(!this->__has_val_, "expected::error requires the expected to contain an error");
    return this->__union_.__unex_;
  ...
  or_else(_Fun&& __fun) &
  {
    ...
    static_assert(
        __expected::__is_expected<_Res>, "Result of std::expected::or_else must be a specialization of std::expected");
  ...
  _LIBCUDACXX_TEMPLATE(class _Fun, class _Tp2 = _Tp, class _Err2 = _Err)
  _LIBCUDACXX_REQUIRES(_LIBCUDACXX_TRAIT(is_copy_constructible, _Err2)
          _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(is_same, __remove_cv_t<invoke_result_t<_Fun, const _Tp2&>>, void))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  transform(_Fun&& __fun) const&
  {
  ...
  transform(_Fun&& __fun) &&
  {
    ...
    if (this->__has_val_) {
      return expected<_Res, _Err>{__expected_construct_from_invoke_tag{},
          in_place,
  ...
  transform_error(_Fun&& __fun) &
  {
    ...
    static_assert(__invoke_constructible<_Fun, _Err&>,
        "std::expected::transform_error requires that the return type of F is constructible with the result of "
        "invoking F");
  ...
  _LIBCUDACXX_REQUIRES(_LIBCUDACXX_TRAIT(is_copy_constructible, _Tp2))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  transform_error(_Fun&& __fun) const&
  {
    static_assert(
        invocable<_Fun, const _Err&>, "std::expected::transform_error requires that F must be invocable with E");
  ...
  transform_error(_Fun&& __fun) &&
  {
    ...
    if (this->__has_val_) {
      ...
      return expected<_Tp, _Res>{__expected_construct_from_invoke_tag{},
          unexpect,
          _CUDA_VSTD::forward<_Fun>(__fun),
    ...
    , private __expected_void_sfinae_assign_base_t<_Err>
{
  ...
  using __can_convert = _And< is_void<_Up>, is_constructible<_Err, _OtherErrQual>,
      _Not<is_constructible<unexpected<_Err>, expected<_Up, _OtherErr>&>>,
      _Not<is_constructible<unexpected<_Err>, expected<_Up, _OtherErr>>>,
      _Not<is_constructible<unexpected<_Err>, const expected<_Up, _OtherErr>&>>,
      _Not<is_constructible<unexpected<_Err>, const expected<_Up, _OtherErr>>>>;
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17
  expected(const expected<_Up, _OtherErr>& __other) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err,
      const _OtherErr&)) // strengthened
      : __base(__other.__has_val_)
  {
    if (!__other.__has_val_) {
  ...
  _LIBCUDACXX_REQUIRES(__can_convert<_Up, _OtherErr, const _OtherErr&>::value _LIBCUDACXX_AND(
      !_LIBCUDACXX_TRAIT(is_convertible, const _OtherErr&, _Err)))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 explicit expected(
      const expected<_Up, _OtherErr>& __other) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err,
      const _OtherErr&)) // strengthened
      : __base(__other.__has_val_)
  {
    if (!__other.__has_val_) {
  ...
  _LIBCUDACXX_TEMPLATE(class _Up, class _OtherErr)
  _LIBCUDACXX_REQUIRES(__can_convert<_Up, _OtherErr, _OtherErr>::value _LIBCUDACXX_AND _LIBCUDACXX_TRAIT(
      is_convertible, _OtherErr, _Err))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17
  expected(expected<_Up, _OtherErr>&& __other) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err,
      _OtherErr)) // strengthened
      : __base(__other.__has_val_)
  {
    if (!__other.__has_val_) {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 explicit expected(
      expected<_Up, _OtherErr>&& __other) noexcept(_LIBCUDACXX_TRAIT(is_nothrow_constructible, _Err,
      _OtherErr)) // strengthened
      : __base(__other.__has_val_)
  {
    if (!__other.__has_val_) {
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 expected&
  operator=(unexpected<_OtherErr>&& __un) noexcept(
      _LIBCUDACXX_TRAIT(is_nothrow_assignable, _Err&, _OtherErr)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void
  swap(expected<void, _Err2>& __rhs) noexcept(
      _LIBCUDACXX_TRAIT(is_nothrow_move_constructible, _Err2) && _LIBCUDACXX_TRAIT(is_nothrow_swappable, _Err2))
  {
    if (this->__has_val_) {
      if (!__rhs.__has_val_) {
  ...
  transform_error(_Fun&& __fun) &&
  {
    ...
    if (this->__has_val_) {
      ...
      return expected<void, _Res>{__expected_construct_from_invoke_tag{},
          unexpect,
          _CUDA_VSTD::forward<_Fun>(__fun),
          _CUDA_VSTD::move(this->__union_.__unex_)};
    }
