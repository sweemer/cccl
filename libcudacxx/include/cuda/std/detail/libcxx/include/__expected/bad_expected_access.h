...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY const char*
  what() const noexcept override
  {
    return "bad access to _CUDA_VSTD::expected";
  }
};
...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _Err&
  error() & noexcept
  {
    return __unex_;
  }

  _LIBCUDACXX_INLINE_VISIBILITY const _Err&
