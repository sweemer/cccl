...
inline _LIBCUDACXX_INLINE_VISIBILITY constexpr int
__convert_to_integral(int __val)
{
  return __val;
}

inline _LIBCUDACXX_INLINE_VISIBILITY constexpr unsigned
__convert_to_integral(unsigned __val)
{
  return __val;
}

inline _LIBCUDACXX_INLINE_VISIBILITY constexpr long
__convert_to_integral(long __val)
{
  return __val;
}

inline _LIBCUDACXX_INLINE_VISIBILITY constexpr unsigned long
__convert_to_integral(unsigned long __val)
{
  return __val;
}

inline _LIBCUDACXX_INLINE_VISIBILITY constexpr long long
__convert_to_integral(long long __val)
{
  return __val;
}

inline _LIBCUDACXX_INLINE_VISIBILITY constexpr unsigned long long
...
inline _LIBCUDACXX_INLINE_VISIBILITY constexpr __int128_t
__convert_to_integral(__int128_t __val)
{
  return __val;
}

inline _LIBCUDACXX_INLINE_VISIBILITY constexpr __uint128_t
