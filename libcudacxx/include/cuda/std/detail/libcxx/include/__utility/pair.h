...
{
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __non_trivially_copyable_base() noexcept {}
...
#endif
{
  ...
  struct _CheckArgs
  {
    ...
    struct __enable_explicit_default
        : public integral_constant<bool, is_default_constructible<_T1>::value && is_default_constructible<_T2>::value
                                             && !__enable_implicit_default::value>
    {};

    template <class _U1, class _U2>
    struct __is_pair_constructible
        : public integral_constant<bool,
              is_constructible<first_type, _U1>::value && is_constructible<second_type, _U2>::value>
    {};

    template <class _U1, class _U2>
    struct __is_implicit
        : public integral_constant<bool,
              is_convertible<_U1, first_type>::value && is_convertible<_U2, second_type>::value>
    {};

    template <class _U1, class _U2>
    struct __enable_explicit
        : public integral_constant<bool, __is_pair_constructible<_U1, _U2>::value && !__is_implicit<_U1, _U2>::value>
    {};
  ...
  using _CheckArgsDep _LIBCUDACXX_NODEBUG_TYPE =
      __conditional_t< _MaybeEnable, _CheckArgs, __check_tuple_constructor_fail>;

  struct _CheckTupleLikeConstructor
  {
    template <class _Tuple>
    struct __enable_implicit : public integral_constant<bool, __tuple_convertible<_Tuple, pair>::value>
    {};
    template <class _Tuple>
    struct __enable_explicit
        : public integral_constant<bool,
              __tuple_constructible<_Tuple, pair>::value && !__tuple_convertible<_Tuple, pair>::value>
    {};
    template <class _Tuple>
    struct __enable_assign : public integral_constant<bool, __tuple_assignable<_Tuple, pair>::value>
    {};
  };

  template <class _Tuple>
  using _CheckTLC _LIBCUDACXX_NODEBUG_TYPE =
      __conditional_t< __tuple_like_with_size<_Tuple, 2>::value && !is_same<__decay_t<_Tuple>, pair>::value,
          _CheckTupleLikeConstructor, __check_tuple_constructor_fail >;

  template <bool _Dummy = true, __enable_if_t< _CheckArgsDep<_Dummy>::__enable_explicit_default::value >* = nullptr>
  explicit _LIBCUDACXX_INLINE_VISIBILITY constexpr pair() noexcept(
      is_nothrow_default_constructible<first_type>::value && is_nothrow_default_constructible<second_type>::value)
      : first()
      , second()
  {}

  template <bool _Dummy = true, __enable_if_t< _CheckArgsDep<_Dummy>::__enable_implicit_default::value >* = nullptr>
  ...
  template <bool _Dummy = true, __enable_if_t< _CheckArgsDep<_Dummy>::template __enable_explicit<
                                    __make_const_lvalue_ref<_T1>, __make_const_lvalue_ref<_T2>>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(_T1 const& __t1,
      _T2 const& __t2) noexcept(is_nothrow_copy_constructible<first_type>::value
                                && is_nothrow_copy_constructible<second_type>::value)
      : first(__t1)
      , second(__t2)
  {}

  template <bool _Dummy = true, __enable_if_t< _CheckArgsDep<_Dummy>::template __enable_implicit<
                                    __make_const_lvalue_ref<_T1>, __make_const_lvalue_ref<_T2>>::value >* = nullptr>
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(_U1&& __u1, _U2&& __u2) noexcept(
      (is_nothrow_constructible<first_type, _U1>::value && is_nothrow_constructible<second_type, _U2>::value))
      : first(_CUDA_VSTD::forward<_U1>(__u1))
      , second(_CUDA_VSTD::forward<_U2>(__u2))
  {}
  ...
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __is_pair_constructible<_U1&, _U2&>::value >* = nullptr>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit(
      !_CheckArgs::template __is_implicit<_U1&, _U2&>())
...
#  if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __is_pair_constructible<_U1&, _U2&>::value >* = nullptr>
  _LIBCUDACXX_HOST _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit(!_CheckArgs::template __is_implicit<_U1&, _U2&>())
      pair(::std::pair<_U1, _U2>& __p) noexcept(
          (is_nothrow_constructible<first_type, _U1&>::value && is_nothrow_constructible<second_type, _U2&>::value))
      : first(__p.first)
      , second(__p.second)
  {}
#  endif // defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  ...
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __enable_explicit<_U1 const&, _U2 const&>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(pair<_U1, _U2> const& __p) noexcept(
  ...
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __enable_explicit<_U1 const&, _U2 const&>::value >* = nullptr>
  _LIBCUDACXX_HOST _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(::std::pair<_U1, _U2> const& __p) noexcept(
      (is_nothrow_constructible<first_type, _U1 const&>::value
          && is_nothrow_constructible<second_type, _U2 const&>::value))
      : first(__p.first)
      , second(__p.second)
  ...
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __enable_implicit<_U1 const&, _U2 const&>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11
  ...
  pair(::std::pair<_U1, _U2> const& __p) noexcept(
      (is_nothrow_constructible<first_type, _U1 const&>::value
          && is_nothrow_constructible<second_type, _U2 const&>::value))
      : first(__p.first)
      , second(__p.second)
  ...
  template <class _U1, class _U2, __enable_if_t< _CheckArgs::template __enable_explicit<_U1, _U2>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(pair<_U1, _U2>&& __p) noexcept(
      (is_nothrow_constructible<first_type, _U1&&>::value && is_nothrow_constructible<second_type, _U2&&>::value))
...
#if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  template <class _U1, class _U2, __enable_if_t< _CheckArgs::template __enable_explicit<_U1, _U2>::value >* = nullptr>
  _LIBCUDACXX_HOST _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(::std::pair<_U1, _U2>&& __p) noexcept(
      (is_nothrow_constructible<first_type, _U1&&>::value && is_nothrow_constructible<second_type, _U2&&>::value))
      : first(_CUDA_VSTD::forward<_U1>(__p.first))
      , second(_CUDA_VSTD::forward<_U2>(__p.second))
  {}
  ...
  template <class _U1, class _U2, __enable_if_t< _CheckArgs::template __enable_implicit<_U1, _U2>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11
  pair(pair<_U1, _U2>&& __p) noexcept(
      (is_nothrow_constructible<first_type, _U1&&>::value && is_nothrow_constructible<second_type, _U2&&>::value))
      : first(_CUDA_VSTD::forward<_U1>(__p.first))
...
#if _LIBCUDACXX_STD_VER > 20
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __is_pair_constructible<const _U1&&, const _U2&&>::value >* = nullptr>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit(
      !_CheckArgs::template __is_implicit<const _U1&&, const _U2&&>::value)
      pair(const pair<_U1, _U2>&& __p) noexcept(
          is_nothrow_constructible<first_type, const _U1&&>::value
          && is_nothrow_constructible<second_type, const _U2&&>::value)
      : first(_CUDA_VSTD::move(__p.first))
      , second(_CUDA_VSTD::move(__p.second))
  {}

#  if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  template <class _U1, class _U2,
      __enable_if_t< _CheckArgs::template __is_pair_constructible<const _U1&&, const _U2&&>::value >* = nullptr>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_HOST constexpr explicit(
      !_CheckArgs::template __is_implicit<const _U1&&, const _U2&&>::value)
      pair(const ::std::pair<_U1, _U2>&& __p) noexcept(
          is_nothrow_constructible<first_type, const _U1&&>::value
          && is_nothrow_constructible<second_type, const _U2&&>::value)
      : first(_CUDA_VSTD::move(__p.first))
      , second(_CUDA_VSTD::move(__p.second))
...
#  endif // defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  ...
  template <class _Tuple, __enable_if_t< _CheckTLC<_Tuple>::template __enable_explicit<_Tuple>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 explicit pair(_Tuple&& __p)
      : first(_CUDA_VSTD::get<0>(_CUDA_VSTD::forward<_Tuple>(__p)))
      , second(_CUDA_VSTD::get<1>(_CUDA_VSTD::forward<_Tuple>(__p)))
  {}

  template <class _Tuple, __enable_if_t< _CheckTLC<_Tuple>::template __enable_implicit<_Tuple>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11
  pair(_Tuple&& __p)
      : first(_CUDA_VSTD::get<0>(_CUDA_VSTD::forward<_Tuple>(__p)))
      , second(_CUDA_VSTD::get<1>(_CUDA_VSTD::forward<_Tuple>(__p)))
  ...
  pair(piecewise_construct_t __pc, tuple<_Args1...> __first_args, tuple<_Args2...> __second_args) noexcept(
      (is_nothrow_constructible<first_type, _Args1...>::value
          && is_nothrow_constructible<second_type, _Args2...>::value))
      : pair(__pc, __first_args, __second_args, typename __make_tuple_indices<sizeof...(_Args1)>::type(),
          typename __make_tuple_indices<sizeof...(_Args2) >::type())
  {}

  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 pair&
  operator=(__conditional_t< is_copy_assignable<first_type>::value && is_copy_assignable<second_type>::value, pair,
  ...
  _LIBCUDACXX_HOST _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 pair&
  operator=(::std::pair<_T1, _T2> const& __p) noexcept(
      is_nothrow_copy_assignable<first_type>::value && is_nothrow_copy_assignable<second_type>::value)
  {
    first  = __p.first;
    second = __p.second;
    return *this;
  ...
  operator=(
      __conditional_t< is_move_assignable<first_type>::value && is_move_assignable<second_type>::value, pair, __nat>&&
          __p) noexcept(is_nothrow_move_assignable<first_type>::value && is_nothrow_move_assignable<second_type>::value)
  {
  ...
  _LIBCUDACXX_HOST _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 pair&
  operator=(::std::pair<_T1, _T2>&& __p) noexcept(
      is_nothrow_move_assignable<first_type>::value && is_nothrow_move_assignable<second_type>::value)
  {
    first  = _CUDA_VSTD::forward<first_type>(__p.first);
    second = _CUDA_VSTD::forward<second_type>(__p.second);
    return *this;
...
#  if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_HOST constexpr const pair&
  operator=(::std::pair<_T1, _T2> const& __p) const
      noexcept(is_nothrow_copy_assignable_v<const first_type> && is_nothrow_copy_assignable_v<const second_type>)
    requires(is_copy_assignable_v<const first_type> && is_copy_assignable_v<const second_type>)
  {
    first  = __p.first;
...
#  if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_HOST constexpr const pair&
  operator=(::std::pair<_T1, _T2>&& __p) const
      noexcept(is_nothrow_assignable_v<const first_type&, first_type>
               && is_nothrow_assignable_v<const second_type&, second_type>)
    requires(is_assignable_v<const first_type&, first_type> && is_assignable_v<const second_type&, second_type>)
  {
...
#  if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  template <class _U1, class _U2>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_HOST constexpr const pair&
  operator=(const ::std::pair<_U1, _U2>& __p) const
    requires(is_assignable_v<const first_type&, const _U1&> && is_assignable_v<const second_type&, const _U2&>)
  {
    first  = __p.first;
    second = __p.second;
...
#  if defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  template <class _U1, class _U2>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_HOST constexpr const pair&
  operator=(::std::pair<_U1, _U2>&& __p) const
    requires(is_assignable_v<const first_type&, _U1> && is_assignable_v<const second_type&, _U2>)
  {
    first  = _CUDA_VSTD::forward<_U1>(__p.first);
    second = _CUDA_VSTD::forward<_U2>(__p.second);
...
#  endif // defined(__cuda_std__) && !defined(__CUDACC_RTC__)
  ...
  template <class _Tuple, __enable_if_t< _CheckTLC<_Tuple>::template __enable_assign<_Tuple>::value >* = nullptr>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 pair&
  operator=(_Tuple&& __p)
  {
    first  = _CUDA_VSTD::get<0>(_CUDA_VSTD::forward<_Tuple>(__p));
...
private:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 pair(piecewise_construct_t,
      tuple<_Args1...>& __first_args, tuple<_Args2...>& __second_args, __tuple_indices<_I1...>,
      __tuple_indices<_I2...>);
};
...
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_comparison_category_t<
    __synth_three_way_result<_T1>, __synth_three_way_result<_T2> >
operator<=>(const pair<_T1, _T2>& __x, const pair<_T1, _T2>& __y)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY
    ...
    swap(pair<_T1, _T2>& __x, pair<_T1, _T2>& __y) noexcept(
...
{
  template <class _T1, class _T2>
  static _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 _T1&
...
{
  template <class _T1, class _T2>
  static _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 _T2&
  get(pair<_T1, _T2>& __p) noexcept
  {
    return __p.second;
  }
...
template <size_t _Ip, class _T1, class _T2>
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 const typename tuple_element<_Ip,
    pair<_T1, _T2> >::type&
get(const pair<_T1, _T2>& __p) noexcept
{
  return __get_pair<_Ip>::get(__p);
