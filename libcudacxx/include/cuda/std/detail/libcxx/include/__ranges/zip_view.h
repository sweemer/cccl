...
_LIBCUDACXX_CONCEPT __zip_is_common = (sizeof...(_Ranges) == 1 && (common_range<_Ranges> && ...)) ||
...
template <class... _Types>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
auto __tuple_or_pair_test() _LIBCUDACXX_TRAILING_REQUIRES(tuple<_Types...>)
...
struct __zv_functors {
  ...
  struct __zip_begin {
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::begin)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const noexcept(
    noexcept(__tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::begin)&, _Types>...>
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr auto __view_begin(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_end {
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::end)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const noexcept(
    noexcept(__tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::end)&, _Types>...>
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr auto __view_end(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_size {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    static constexpr auto __get_min(_Sizes&&... __tuple_sizes) noexcept {
    ...
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr auto operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(__zip_size::__get_min(_CUDA_VSTD::invoke(_CUDA_VRANGES::size, _CUDA_VSTD::forward<_Types>(__tuple_elements))...))) {
      return   __zip_size::__get_min(_CUDA_VSTD::invoke(_CUDA_VRANGES::size, _CUDA_VSTD::forward<_Types>(__tuple_elements))...);
    }
  };

  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr auto __view_size(_Tuple&& __tuple) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr bool __iter_op_eq(const _Tuple1& __tuple1, const _Tuple2& __tuple2, index_sequence<_Indices...>) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr bool __iter_op_eq(const _Tuple1& __tuple1, const _Tuple2& __tuple2) noexcept(
    noexcept(__zv_functors::__iter_op_eq(__tuple1, __tuple2, _CUDA_VSTD::make_index_sequence<tuple_size_v<remove_cvref_t<_Tuple1>>>()))) {
    return   __zv_functors::__iter_op_eq(__tuple1, __tuple2, _CUDA_VSTD::make_index_sequence<tuple_size_v<remove_cvref_t<_Tuple1>>>());
  }
  ...
  struct __zip_op_star {
    struct __op_star {
      ...
      _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
      constexpr decltype(auto) operator()(_Iter& __i) const noexcept(noexcept(*__i)) { return *__i; }
    };

    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __tuple_or_pair<invoke_result_t<__op_star&, _Types>...>
    operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(__tuple_or_pair<invoke_result_t<__op_star&, _Types>...>
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr auto __iter_op_star(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_increment {
    struct __op_increment {
      template <class _Iter>
      _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
      constexpr void operator()(_Iter& __i) const noexcept(noexcept(++__i)) { ++__i; }
    };

    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr void operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(( _CUDA_VSTD::invoke(__op_increment{}, _CUDA_VSTD::forward<_Types>(__tuple_elements)), ...))) {
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr void __iter_op_increment(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_decrement {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr void operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(( _CUDA_VSTD::invoke(__op_decrement{}, _CUDA_VSTD::forward<_Types>(__tuple_elements)), ...))) {
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr void __iter_op_decrement(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_pe {
    ...
    struct __op_pe {
      ...
      template <class _Iter>
      _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
      constexpr void operator()(_Iter& __i) const noexcept(
        noexcept(__i += iter_difference_t<_Iter>(__x))) {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr void operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(( _CUDA_VSTD::invoke(__op_pe{__x}, _CUDA_VSTD::forward<_Types>(__tuple_elements)), ...))) {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr void __iter_op_pe(_Diff __x, _Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_me {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr void operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(( _CUDA_VSTD::invoke(__op_me{__x}, _CUDA_VSTD::forward<_Types>(__tuple_elements)), ...))) {
  ...
  template <class _Diff, class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr void __iter_op_me(_Diff __x, _Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_index {
    ...
    struct __op_index {
      ...
      template <class _Iter>
      _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
      constexpr decltype(auto) operator()(_Iter& __i) const noexcept(
        noexcept(__i[iter_difference_t<_Iter>(__n)])) {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr auto operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(__tuple_or_pair<invoke_result_t<__zip_op_index::__op_index&, _Types>...>{ _CUDA_VSTD::invoke(__zip_op_index::__op_index{__n}, _CUDA_VSTD::forward<_Types>(__tuple_elements))...})) {
      return   __tuple_or_pair<invoke_result_t<__zip_op_index::__op_index&, _Types>...>{ _CUDA_VSTD::invoke(__zip_op_index::__op_index{__n}, _CUDA_VSTD::forward<_Types>(__tuple_elements))...};
    }
  };

  template <class _Diff, class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr auto __iter_op_index(_Diff __n, _Tuple&& __tuple) noexcept(
  ...
  struct __op_comp_abs {
    ...
    template <class _Diff>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    static constexpr _Diff __abs(_Diff __t) noexcept(
      noexcept(__t < 0 ? -__t : __t)) {
      return   __t < 0 ? -__t : __t;
    }

    template <class _Diff>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr bool operator()(const _Diff& __x, const _Diff& __y) const noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr _Diff __iter_op_minus(const _Tuple1& __tuple1, const _Tuple2& __tuple2, index_sequence<_Zero, _Indices...>) noexcept(
    noexcept(((_CUDA_VSTD::get<_Indices>(__tuple1) - _CUDA_VSTD::get<_Indices>(__tuple2)) && ...))) {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr _Diff __iter_op_minus(const _Tuple1& __tuple1, const _Tuple2& __tuple2) noexcept(
    noexcept(__zv_functors::__iter_op_minus<_Diff>(__tuple1, __tuple2, _CUDA_VSTD::make_index_sequence<tuple_size_v<remove_cvref_t<_Tuple1>>>()))) {
    return   __zv_functors::__iter_op_minus<_Diff>(__tuple1, __tuple2, _CUDA_VSTD::make_index_sequence<tuple_size_v<remove_cvref_t<_Tuple1>>>());
  }

  struct __zip_iter_move {
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::iter_move)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const noexcept(
      noexcept(__tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::iter_move)&, _Types>...>
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr auto __iter_move(_Tuple&& __tuple) noexcept(
  ...
  template <class _Tuple1, class _Tuple2, size_t... _Indices>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr void __iter_swap(_Tuple1&& __tuple1, _Tuple2&& __tuple2, index_sequence<_Indices...>)
  ...
  template <class _Tuple1, class _Tuple2>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  static constexpr void __iter_swap(_Tuple1&& __tuple1, _Tuple2&& __tuple2) noexcept(
    noexcept(__zv_functors::__iter_swap(_CUDA_VSTD::forward<_Tuple1>(__tuple1), _CUDA_VSTD::forward<_Tuple2>(__tuple2),
                                        _CUDA_VSTD::make_index_sequence<tuple_size<remove_cvref_t<_Tuple1>>::value>()))) {
    return   __zv_functors::__iter_swap(_CUDA_VSTD::forward<_Tuple1>(__tuple1), _CUDA_VSTD::forward<_Tuple2>(__tuple2),
                                        _CUDA_VSTD::make_index_sequence<tuple_size<remove_cvref_t<_Tuple1>>::value>());
  }
};
...
template <bool _Const, class... _Views>
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
constexpr auto __get_zip_view_iterator_tag() {
...
template <bool _Const, class... _Views>
using __zv_iter_category_base = _If<__zip_all_forward<_Const, _Views...>,
  __zv_iter_category_base_tag, __zv_iter_category_base_none>;
...
class zip_view : public view_interface<zip_view<_Views...>> {
 ...
 && !defined(_LIBCUDACXX_CUDACC_BELOW_11_3)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit zip_view(_Views... __views) : __views_(_CUDA_VSTD::move(__views)...) {}

  _LIBCUDACXX_TEMPLATE(class _Packed = __packed_views<_Views...>)
    (requires _Packed::__none_simple)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  ...
  _LIBCUDACXX_TEMPLATE(class _Packed = __packed_views<_Views...>)
    (requires _Packed::__all_const_range)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  ...
  _LIBCUDACXX_TEMPLATE(class _Packed = __packed_views<_Views...>)
    (requires _Packed::__all_sized_range)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr auto size() {
  ...
  _LIBCUDACXX_TEMPLATE(class _Packed = __packed_views<_Views...>)
    (requires _Packed::__all_const_sized_range)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
...
public:
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit __zip_iterator(__tuple_or_pair<iterator_t<__maybe_const<_Const, _Views>>...> __current)
  ...
  __zip_iterator() = default;

  template <bool _OtherConst>
  static constexpr bool __all_convertible = (convertible_to<iterator_t<_Views>, iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
    (requires _OtherConst _LIBCUDACXX_AND __all_convertible<_OtherConst>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __zip_iterator(__zip_iterator<!_OtherConst, _Views...> __i)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __zip_iterator& operator++() {
    __zv_functors::__iter_op_increment(__current_);
    return *this;
  }

  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
    (requires (!__zip_all_forward<_OtherConst, _Views...>))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  ...
  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
    (requires __zip_all_forward<_OtherConst, _Views...>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __zip_iterator operator++(int) {
    auto __tmp = *this;
    ++*this;
    return __tmp;
  }
  ...
  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
    (requires __zip_all_bidirectional<_OtherConst, _Views...>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __zip_iterator& operator--() {
  ...
  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
    (requires __zip_all_random_access<_OtherConst, _Views...>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __zip_iterator& operator+=(difference_type __x) {
  ...
  template<bool _OtherConst>
  static constexpr bool __all_equality_comparable = (equality_comparable<iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  template<bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator==(const __zip_iterator& __x, const __zip_iterator& __y)
    _LIBCUDACXX_TRAILING_REQUIRES(bool) (requires __all_equality_comparable<_OtherConst>)
  {
  ...
  template<bool _OtherConst>
  static constexpr bool __all_three_way_comparable = (three_way_comparable<iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  template<bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator<=>(const __zip_iterator& __x, const __zip_iterator& __y) _LIBCUDACXX_TRAILING_REQUIRES(bool)
    (requires __zip_all_random_access<_OtherConst, _Views...> &&
              __all_three_way_comparable<_OtherConst>)
  {
    return __x.__current_ <=> __y.__current_;
  }
  ...
  template<bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator+(const __zip_iterator& __i, difference_type __n) _LIBCUDACXX_TRAILING_REQUIRES(__zip_iterator)
    (requires __zip_all_random_access<_OtherConst, _Views...>)
  {
    auto __r = __i;
    __r += __n;
  ...
  template<bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator+(difference_type __n, const __zip_iterator& __i) _LIBCUDACXX_TRAILING_REQUIRES(__zip_iterator)
    (requires __zip_all_random_access<_OtherConst, _Views...>)
  {
    return __i + __n;
  }
  ...
  template<bool _OtherConst>
  static constexpr bool __all_sized_sentinel = (sized_sentinel_for<iterator_t<__maybe_const<_OtherConst, _Views>>, iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  template<bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator-(const __zip_iterator& __x, const __zip_iterator& __y) _LIBCUDACXX_TRAILING_REQUIRES(difference_type)
    (requires __all_sized_sentinel<_OtherConst>)
  {
    return __zv_functors::__iter_op_minus<difference_type>(__x.__current_, __y.__current_);
  }

  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto iter_move(const __zip_iterator& __i) noexcept(
  ...
  template<bool _OtherConst>
  static constexpr bool __all_indirectly_swappable = (indirectly_swappable<iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  template<bool _OtherConst>
  static constexpr bool __all_noexcept_swappable = (__noexcept_swappable<iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  template<bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto iter_swap(const __zip_iterator& __l, const __zip_iterator& __r)
    noexcept(__all_noexcept_swappable<_OtherConst>)
    _LIBCUDACXX_TRAILING_REQUIRES(void) (requires __all_indirectly_swappable<_OtherConst>)
  {
...
public:
  _LIBCUDACXX_HIDE_FROM_ABI
  __zip_sentinel() = default;

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit __zip_sentinel(__tuple_or_pair<sentinel_t<__maybe_const<_Const, _Views>>...> __end) : __end_(__end) {}
  ...
  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
    (requires _OtherConst _LIBCUDACXX_AND __all_convertible<_OtherConst>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __zip_sentinel(__zip_sentinel<!_OtherConst, _Views...> __i)
    : __end_(_CUDA_VSTD::move(__i.__end_)) {}

  template<bool _OtherConst>
  static constexpr bool __all_sentinel = (sentinel_for<sentinel_t<__maybe_const<_Const, _Views>>, iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);

  template <bool _OtherConst>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator==(const __iterator<_OtherConst>& __x, const __zip_sentinel& __y)
    _LIBCUDACXX_TRAILING_REQUIRES(bool) (requires __all_sentinel<_OtherConst>)
  {
  ...
  template <bool _OtherConst>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator==(const __zip_sentinel& __x, const __iterator<_OtherConst>& __y)
    _LIBCUDACXX_TRAILING_REQUIRES(bool) (requires __all_sentinel<_OtherConst>)
  {
  ...
  template<bool _OtherConst>
  static constexpr bool __all_sized_sentinel = (sized_sentinel_for<sentinel_t<__maybe_const<_Const, _Views>>, iterator_t<__maybe_const<_OtherConst, _Views>>> && ...);
  ...
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr
  auto operator-(const __iterator<_OtherConst>& __x, const __zip_sentinel& __y)
    _LIBCUDACXX_TRAILING_REQUIRES(_OtherDiff<_OtherConst>)
    (requires __all_sized_sentinel<_OtherConst>)
  {
...
struct __fn {
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr auto operator()() const noexcept { return empty_view<tuple<>>{}; }

  template<class... _Ranges>
  static constexpr bool __all_input = (input_range<_Ranges> && ...);

  _LIBCUDACXX_TEMPLATE(class... _Ranges)
    (requires (sizeof...(_Ranges) > 0) _LIBCUDACXX_AND __all_input<_Ranges...>)
...
#if defined(_LIBCUDACXX_COMPILER_GCC) && _LIBCUDACXX_STD_VER < 20
...
#endif // defined(_LIBCUDACXX_COMPILER_GCC) && _LIBCUDACXX_STD_VER < 20
