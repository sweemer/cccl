...
struct atomic : public std::__atomic_base<_Tp, _Sco>
{
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp
  fetch_max(const _Tp& __op, memory_order __m = memory_order_seq_cst) volatile noexcept
  {
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp
  fetch_min(const _Tp& __op, memory_order __m = memory_order_seq_cst) volatile noexcept
  {
...
struct atomic<_Tp*, _Sco> : public std::__atomic_base<_Tp*, _Sco>
{
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  fetch_add(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) volatile noexcept
  {
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  fetch_sub(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) volatile noexcept
  {
...
struct atomic_ref : public std::__atomic_base_ref<_Tp, _Sco>
{
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp
  operator=(_Tp __d) const volatile noexcept
  {
    __base::store(__d);
    return __d;
  }
  _LIBCUDACXX_HOST_DEVICE
  _Tp
  operator=(_Tp __d) const noexcept
  {
    __base::store(__d);
    return __d;
  }
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp
  fetch_max(const _Tp& __op, memory_order __m = memory_order_seq_cst) const volatile noexcept
  {
    return std::__detail::__cxx_atomic_fetch_max(&this->__a_, __op, __m);
  }
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp
  fetch_min(const _Tp& __op, memory_order __m = memory_order_seq_cst) const volatile noexcept
  {
    return std::__detail::__cxx_atomic_fetch_min(&this->__a_, __op, __m);
  }
};
...
struct atomic_ref<_Tp*, _Sco> : public std::__atomic_base_ref<_Tp*, _Sco>
{
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  fetch_add(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) const volatile noexcept
  {
    return __cxx_atomic_fetch_add(&this->__a_, __op, __m);
  }
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  fetch_add(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) const noexcept
  {
    return __cxx_atomic_fetch_add(&this->__a_, __op, __m);
  }
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  fetch_sub(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) const volatile noexcept
  {
    return __cxx_atomic_fetch_sub(&this->__a_, __op, __m);
  }
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  fetch_sub(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) const noexcept
  {
    return __cxx_atomic_fetch_sub(&this->__a_, __op, __m);
  }
  ...
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  operator+=(ptrdiff_t __op) const volatile noexcept
  {
    return fetch_add(__op) + __op;
  }
  _LIBCUDACXX_HOST_DEVICE
  _Tp*
  operator+=(ptrdiff_t __op) const noexcept
  {
    return fetch_add(__op) + __op;
  }
  _LIBCUDACXX_HOST_DEVICE
