...
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(_Default_initializable_,
...
_LIBCUDACXX_CONCEPT_FRAGMENT(
    __move_constructible_, requires()(requires(constructible_from<_Tp, _Tp>), requires(convertible_to<_Tp, _Tp>)));
...
// [concept.copyconstructible]
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__copy_constructible_,
    requires()(requires(move_constructible<_Tp>),
        requires(
            constructible_from<_Tp, add_lvalue_reference_t<_Tp>>&& convertible_to<add_lvalue_reference_t<_Tp>, _Tp>),
