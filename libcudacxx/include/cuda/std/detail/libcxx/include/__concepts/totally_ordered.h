...
_LIBCUDACXX_CONCEPT_FRAGMENT(__partially_ordered_with_,
    requires(__make_const_lvalue_ref<_Tp> __t, __make_const_lvalue_ref<_Up> __u)(
        requires(__boolean_testable<decltype(__t < __u)>), requires(__boolean_testable<decltype(__t > __u)>),
        requires(__boolean_testable<decltype(__t <= __u)>), requires(__boolean_testable<decltype(__t >= __u)>),
        requires(__boolean_testable<decltype(__u < __t)>), requires(__boolean_testable<decltype(__u > __t)>),
        requires(__boolean_testable<decltype(__u <= __t)>), requires(__boolean_testable<decltype(__u >= __t)>)));
...
template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT_FRAGMENT(__totally_ordered_with_,
    requires()(requires(totally_ordered<_Tp>), requires(totally_ordered<_Up>),
