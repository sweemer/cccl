...
_LIBCUDACXX_CONCEPT_FRAGMENT(
    __common_type_exists_, requires()(typename(common_type_t<_Tp, _Up>), typename(common_type_t<_Up, _Tp>)));

template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT _Common_type_exists = _LIBCUDACXX_FRAGMENT(__common_type_exists_, _Tp, _Up);

template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT_FRAGMENT(__common_type_constructible_,
...
template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT_FRAGMENT(__common_with_,
    requires()(requires(_Common_type_constructible<_Tp, _Up>),
