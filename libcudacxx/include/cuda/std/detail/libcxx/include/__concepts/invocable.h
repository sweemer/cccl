...
concept invocable = requires(_Fn&& __fn, _Args&&... __args) {
  _CUDA_VSTD::__invoke(
      _CUDA_VSTD::forward<_Fn>(__fn), _CUDA_VSTD::forward<_Args>(__args)...); // not required to be equality preserving
};
...
template <class _Fun, class... _Args>
_LIBCUDACXX_CONCEPT_FRAGMENT(__invoke_constructible_,
