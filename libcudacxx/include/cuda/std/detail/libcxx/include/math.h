...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD bool
...
inline _LIBCUDACXX_INLINE_VISIBILITY long
...
inline _LIBCUDACXX_INLINE_VISIBILITY float
abs(float __lcpp_x) noexcept
{
  return ::fabsf(__lcpp_x);
}

inline _LIBCUDACXX_INLINE_VISIBILITY double
...
// MSVCRT already has the correct prototype in <stdlib.h> if __cplusplus is defined
#    if !defined(_LIBCUDACXX_MSVCRT) && !defined(__sun__) && !defined(_AIX)
inline _LIBCUDACXX_INLINE_VISIBILITY ldiv_t
div(long __x, long __y) noexcept
{
  return ::ldiv(__x, __y);
}
#      ifndef _LIBCUDACXX_HAS_NO_LONG_LONG
inline _LIBCUDACXX_INLINE_VISIBILITY lldiv_t
