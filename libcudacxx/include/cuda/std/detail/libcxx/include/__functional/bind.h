...
struct is_placeholder
    : _If< _IsSame<_Tp, __remove_cvref_t<_Tp> >::value, integral_constant<int, 0>,
...
template <class _Ti, class _Uj>
inline _LIBCUDACXX_INLINE_VISIBILITY __enable_if_t< 0 < is_placeholder<_Ti>::value,
...
inline _LIBCUDACXX_INLINE_VISIBILITY __enable_if_t<
    !is_bind_expression<_Ti>::value && is_placeholder<_Ti>::value == 0 && !__is_reference_wrapper<_Ti>::value, _Ti& >
__mu(_Ti& __ti, _Uj&)
{
  return __ti;
}
...
template <class _Ti, class _TupleUj>
struct __mu_return
    : public __mu_return_impl<_Ti, __is_reference_wrapper<_Ti>::value, is_bind_expression<_Ti>::value,
...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 explicit __bind(_Gp&& __f, _BA&&... __bound_args)
      : __f_(_CUDA_VSTD::forward<_Gp>(__f))
      , __bound_args_(_CUDA_VSTD::forward<_BA>(__bound_args)...)
  {}

  template <class... _Args>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __bind_return_t<_Fd, _Td, tuple<_Args&&...>>
  ...
  _LIBCUDACXX_INLINE_VISIBILITY
      _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __bind_return_t<const _Fd, const _Td, tuple<_Args&&...>>
...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 explicit __bind_r(_Gp&& __f, _BA&&... __bound_args)
      : base(_CUDA_VSTD::forward<_Gp>(__f), _CUDA_VSTD::forward<_BA>(__bound_args)...)
  {}

  template <class... _Args>
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __enable_if_t<
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17
      __enable_if_t< is_convertible<__bind_return_t<const _Fd, const _Td, tuple<_Args&&...>>, result_type>::value
                         || is_void<_Rp>::value,
          result_type >
      operator()(_Args&&... __args) const
  {
...
template <class _Fp, class... _BoundArgs>
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __bind<_Fp, _BoundArgs...>
...
template <class _Rp, class _Fp, class... _BoundArgs>
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __bind_r<_Rp, _Fp, _BoundArgs...>
bind(_Fp&& __f, _BoundArgs&&... __bound_args)
{
