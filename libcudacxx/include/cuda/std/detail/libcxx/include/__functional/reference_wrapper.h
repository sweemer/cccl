...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 type&
  get() const noexcept
  {
    return *__f_;
  }
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 typename __invoke_of<type&, _ArgTypes...>::type
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 reference_wrapper<_Tp>
