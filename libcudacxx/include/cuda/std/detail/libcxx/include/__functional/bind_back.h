...
struct __bind_back_op<_NBound, index_sequence<_Ip...>>
{
  ...
  operator()(_Fn&& __f, _BoundArgs&& __bound_args, _Args&&... __args) const
      noexcept(noexcept(_CUDA_VSTD::invoke(_CUDA_VSTD::forward<_Fn>(__f), _CUDA_VSTD::forward<_Args>(__args)...,
          _CUDA_VSTD::get<_Ip>(_CUDA_VSTD::forward<_BoundArgs>(__bound_args))...)))
          -> decltype(_CUDA_VSTD::invoke(_CUDA_VSTD::forward<_Fn>(__f), _CUDA_VSTD::forward<_Args>(__args)...,
              _CUDA_VSTD::get<_Ip>(_CUDA_VSTD::forward<_BoundArgs>(__bound_args))...))
  {
...
template <class _Fn, class... _Args,
    class = enable_if_t< _And< is_constructible<decay_t<_Fn>, _Fn>, is_move_constructible<decay_t<_Fn>>,
        is_constructible<decay_t<_Args>, _Args>..., is_move_constructible<decay_t<_Args>>... >::value >>
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
