...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY const _Target&
  __target() const
  {
    return __f_.first();
  }
  ...
  _LIBCUDACXX_INLINE_VISIBILITY const _Alloc&
  ...
  _LIBCUDACXX_INLINE_VISIBILITY explicit __alloc_func(const _Target& __f, _Alloc&& __a)
      : __f_(
          piecewise_construct, _CUDA_VSTD::forward_as_tuple(__f), _CUDA_VSTD::forward_as_tuple(_CUDA_VSTD::move(__a)))
  {}
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _Rp
  ...
  _LIBCUDACXX_INLINE_VISIBILITY __alloc_func*
  __clone() const
  {
  ...
  static void
  __destroy_and_delete(__alloc_func* __f)
  {
    typedef allocator_traits<_Alloc> __alloc_traits;
...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY __default_alloc_func*
  __clone() const
  {
  ...
  static void
  __destroy_and_delete(__default_alloc_func* __f)
  {
    __f->destroy();
...
class __value_func<_Rp(_ArgTypes...)>
{
  ...
  _LIBCUDACXX_NO_CFI static __func*
  __as_base(void* __p)
  {
...
public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_EXPLICIT
...
#  ifndef _LIBCUDACXX_NO_RTTI
  _LIBCUDACXX_INLINE_VISIBILITY const type_info&
  ...
  _LIBCUDACXX_INLINE_VISIBILITY const _Tp*
...
struct __policy
{
  ...
  __create_empty()
  {
    static const constexpr __policy __policy_ = {nullptr,
        nullptr,
        true,
#  ifndef _LIBCUDACXX_NO_RTTI
        &typeid(void)
...
struct __policy_invoker<_Rp(_ArgTypes...)>
{
  ...
  template <typename _Fun>
  _LIBCUDACXX_INLINE_VISIBILITY static __policy_invoker
  __create()
  {
...
private:
  ...
  static _Rp
  __call_empty(const __policy_storage*, __fast_forward<_ArgTypes>...)
  {
    __throw_bad_function_call();
  }
  ...
  template <typename _Fun>
  static _Rp
  __call_impl(const __policy_storage* __buf, __fast_forward<_ArgTypes>... __args)
  {
...
#    endif
  ...
  virtual void
  __clone(__base<_Rp(_ArgTypes...)>* __p) const
  {
...
#    ifndef _LIBCUDACXX_NO_RTTI
  virtual const void*
  target(type_info const& __ti) const noexcept
  {
