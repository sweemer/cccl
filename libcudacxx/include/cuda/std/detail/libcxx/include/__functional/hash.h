...
inline _LIBCUDACXX_INLINE_VISIBILITY _Size
...
private:
  ...
  static _Size
  __shift_mix(_Size __val)
  {
    return __val ^ (__val >> 47);
  }

  static _Size
  __hash_len_16(_Size __u, _Size __v) _LIBCUDACXX_DISABLE_UBSAN_UNSIGNED_INTEGER_CHECK
  {
  ...
  static _Size
  __hash_len_0_to_16(const char* __s, _Size __len) _LIBCUDACXX_DISABLE_UBSAN_UNSIGNED_INTEGER_CHECK
  {
    if (__len > 8) {
  ...
  static _Size
  __hash_len_17_to_32(const char* __s, _Size __len) _LIBCUDACXX_DISABLE_UBSAN_UNSIGNED_INTEGER_CHECK
  {
  ...
  static _Size
  __hash_len_33_to_64(const char* __s, size_t __len) _LIBCUDACXX_DISABLE_UBSAN_UNSIGNED_INTEGER_CHECK
  {
...
__murmur2_or_cityhash<_Size, 64>::operator()(const void* __key, _Size __len)
{
  ...
  return __hash_len_16(
      __hash_len_16(__v.first, __w.first) + __shift_mix(__y) * __k1 + __z, __hash_len_16(__v.second, __w.second) + __x);
}
...
{
  _LIBCUDACXX_INLINE_VISIBILITY size_t
...
_LIBCUDACXX_INLINE_VISIBILITY inline size_t
...
using __check_hash_requirements _LIBCUDACXX_NODEBUG_TYPE =
    integral_constant<bool, is_copy_constructible<_Hash>::value && is_move_constructible<_Hash>::value
