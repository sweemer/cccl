...
concept __readable_swappable =
    !__unqualified_iter_swap<_T1, _T2> && indirectly_readable<_T1> && indirectly_readable<_T2>
    && swappable_with<iter_reference_t<_T1>, iter_reference_t<_T2>>;

template <class _T1, class _T2>
concept __moveable_storable =
    !__unqualified_iter_swap<_T1, _T2> && !__readable_swappable<_T1, _T2> && indirectly_movable_storable<_T1, _T2>
    && indirectly_movable_storable<_T2, _T1>;
#  else
template <class _T1, class _T2>
_LIBCUDACXX_CONCEPT_FRAGMENT(__unqualified_iter_swap_,
...
template <class _T1, class _T2>
_LIBCUDACXX_CONCEPT_FRAGMENT(__readable_swappable_,
    requires()(requires(!__unqualified_iter_swap<_T1, _T2>), requires(indirectly_readable<_T1>),
        requires(indirectly_readable<_T2>), requires(swappable_with<iter_reference_t<_T1>, iter_reference_t<_T2>>)));

template <class _T1, class _T2>
_LIBCUDACXX_CONCEPT __readable_swappable = _LIBCUDACXX_FRAGMENT(__readable_swappable_, _T1, _T2);

template <class _T1, class _T2>
_LIBCUDACXX_CONCEPT_FRAGMENT(__moveable_storable_,
    requires()(requires(!__unqualified_iter_swap<_T1, _T2>), requires(!__readable_swappable<_T1, _T2>),
        requires(indirectly_movable_storable<_T1, _T2>), requires(indirectly_movable_storable<_T2, _T1>)));
...
struct __fn
{
  ...
  operator()(_T1&& __x, _T2&& __y) const
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr void
  operator()(_T1&& __x, _T2&& __y) const noexcept(noexcept(iter_value_t<_T2>(_CUDA_VRANGES::iter_move(
...
#  else
template <class _I1, class _I2>
_LIBCUDACXX_CONCEPT_FRAGMENT(__indirectly_swappable_,
    requires(const _I1 __i1, const _I2 __i2)(requires(indirectly_readable<_I1>), requires(indirectly_readable<_I2>),
        (_CUDA_VRANGES::iter_swap(__i1, __i1)), (_CUDA_VRANGES::iter_swap(__i2, __i2)),
        (_CUDA_VRANGES::iter_swap(__i1, __i2)), (_CUDA_VRANGES::iter_swap(__i2, __i1))));
