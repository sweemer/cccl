...
_LIBCUDACXX_INLINE_VISIBILITY constexpr size_t
...
template <class _Cont>
_LIBCUDACXX_INLINE_VISIBILITY constexpr auto
ssize(const _Cont& __c) noexcept(
...
_LIBCUDACXX_INLINE_VISIBILITY constexpr ptrdiff_t
ssize(const _Tp (&)[_Sz]) noexcept
{
  return _Sz;
}
#  if defined(_LIBCUDACXX_COMPILER_GCC)
