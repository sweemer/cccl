...
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 _Tp*
...
cbegin(const _Cp& __c) -> decltype(_CUDA_VSTD::begin(__c))
{
...
template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 auto
cend(const _Cp& __c) -> decltype(_CUDA_VSTD::end(__c))
{
