...
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__unqualified_iter_move_,
...
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__move_deref_,
...
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__just_deref_,
    requires(_Tp&& __t)(requires(!__unqualified_iter_move<_Tp>), requires(!__move_deref<_Tp>),
        requires(!is_lvalue_reference_v<decltype(*__t)>)));
...
struct __fn
{
  ...
  _LIBCUDACXX_NODISCARD_ATTRIBUTE _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator()(_Ip&& __i) const noexcept(noexcept(_CUDA_VSTD::move(*_CUDA_VSTD::forward<_Ip>(__i))))
  ...
  _LIBCUDACXX_NODISCARD_ATTRIBUTE _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator()(_Ip&& __i) const noexcept(noexcept(*_CUDA_VSTD::forward<_Ip>(__i)))
...
_LIBCUDACXX_CONCEPT_FRAGMENT(__can_iter_rvalue_reference_t_,
    requires(_Tp& __t)(
        requires(__dereferenceable<_Tp>), requires(__can_reference<decltype(_CUDA_VRANGES::iter_move(__t))>)));
