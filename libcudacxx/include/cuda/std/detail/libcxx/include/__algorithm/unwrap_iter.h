...
struct __unwrap_iter_impl {
  static _LIBCUDACXX_INLINE_VISIBILITY constexpr _Iter __rewrap(_Iter, _Iter __iter) { return __iter; }
  static _LIBCUDACXX_INLINE_VISIBILITY constexpr _Iter __unwrap(_Iter __i) noexcept { return __i; }
};
...
decltype(_Impl::__unwrap(_CUDA_VSTD::declval<_Iter>())) __unwrap_iter(_Iter __i) noexcept {
