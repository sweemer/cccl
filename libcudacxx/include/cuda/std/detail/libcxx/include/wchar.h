...
extern "C++" {
inline _LIBCUDACXX_INLINE_VISIBILITY wchar_t*
__libcpp_wcschr(const wchar_t* __s, wchar_t __c)
{
  return (wchar_t*) wcschr(__s, __c);
}
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD const wchar_t*
wcschr(const wchar_t* __s, wchar_t __c)
{
  return __libcpp_wcschr(__s, __c);
}
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD wchar_t*
