...
inline int
__stronger_order_msvc(int __a, int __b)
{
...
static inline void
__atomic_signal_fence(int __memorder)
{
...
static inline void
__atomic_thread_fence(int __memorder)
{
  if (__memorder != __ATOMIC_RELAXED) {
...
void
__atomic_load_relaxed(const volatile _Type* __ptr, _Type* __ret)
{
...
void
__atomic_load(const volatile _Type* __ptr, _Type* __ret, int __memorder)
{
  switch (__memorder) {
...
template <class _Type, _enable_if_sized_as<_Type, 1> = 0>
void
__atomic_store_relaxed(volatile _Type* __ptr, _Type* __val)
{
...
template <class _Type>
void
__atomic_store(volatile _Type* __ptr, _Type* __val, int __memorder)
{
  switch (__memorder) {
...
template <class _Type, _enable_if_sized_as<_Type, 1> = 0>
bool
__atomic_compare_exchange_relaxed(const volatile _Type* __ptr, _Type* __expected, const _Type* __desired)
{
...
template <class _Type>
bool
__atomic_compare_exchange(_Type volatile* __ptr, _Type* __expected, const _Type* __desired, bool,
    int __success_memorder, int __failure_memorder)
{
  bool success = false;
...
template <class _Type, _enable_if_sized_as<_Type, 1> = 0>
void
__atomic_exchange_relaxed(const volatile _Type* __ptr, const _Type* __val, _Type* __ret)
{
...
template <class _Type>
void
__atomic_exchange(_Type volatile* __ptr, const _Type* __val, _Type* __ret, int __memorder)
{
  switch (__memorder) {
  case __ATOMIC_RELEASE:
    _LIBCUDACXX_COMPILER_OR_MEMORY_BARRIER();
...
void
__atomic_fetch_add_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
{
...
_Type
__atomic_fetch_add(_Type volatile* __ptr, _Delta __val, int __memorder)
{
...
template <class _Type, class _Delta>
_Type
__atomic_fetch_sub(_Type volatile* __ptr, _Delta __val, int __memorder)
{
...
template <class _Type, class _Delta, _enable_if_sized_as<_Type, 1> = 0>
void
__atomic_fetch_and_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
{
...
template <class _Type, class _Delta>
_Type
__atomic_fetch_and(_Type volatile* __ptr, _Delta __val, int __memorder)
{
  alignas(_Type) unsigned char __buf[sizeof(_Type)] = {};
  auto* __dest                                      = reinterpret_cast<_Type*>(__buf);
...
template <class _Type, class _Delta, _enable_if_sized_as<_Type, 1> = 0>
void
__atomic_fetch_xor_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
{
...
template <class _Type, class _Delta>
_Type
__atomic_fetch_xor(_Type volatile* __ptr, _Delta __val, int __memorder)
{
  alignas(_Type) unsigned char __buf[sizeof(_Type)] = {};
  auto* __dest                                      = reinterpret_cast<_Type*>(__buf);
...
template <class _Type, class _Delta, _enable_if_sized_as<_Type, 1> = 0>
void
__atomic_fetch_or_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
{
...
template <class _Type, class _Delta>
_Type
__atomic_fetch_or(_Type volatile* __ptr, _Delta __val, int __memorder)
{
  alignas(_Type) unsigned char __buf[sizeof(_Type)] = {};
  auto* __dest                                      = reinterpret_cast<_Type*>(__buf);
...
template <class _Type>
_Type
__atomic_load_n(const _Type volatile* __ptr, int __memorder)
{
  alignas(_Type) unsigned char __buf[sizeof(_Type)] = {};
  auto* __dest                                      = reinterpret_cast<_Type*>(__buf);
...
template <class _Type>
void
__atomic_store_n(_Type volatile* __ptr, _Type __val, int __memorder)
{
...
template <class _Type>
bool
__atomic_compare_exchange_n(_Type volatile* __ptr, _Type* __expected, _Type __desired, bool __weak,
    int __success_memorder, int __failure_memorder)
{
...
template <class _Type>
_Type
__atomic_exchange_n(_Type volatile* __ptr, _Type __val, int __memorder)
{
  alignas(_Type) unsigned char __buf[sizeof(_Type)] = {};
  auto* __dest                                      = reinterpret_cast<_Type*>(__buf);
...
template <class _Type, class _Delta>
_Type
__atomic_fetch_max(_Type volatile* __ptr, _Delta __val, int __memorder)
{
...
template <class _Type, class _Delta>
_Type
__atomic_fetch_min(_Type volatile* __ptr, _Delta __val, int __memorder)
{
  _Type __expected = __atomic_load_n(__ptr, __ATOMIC_RELAXED);
  _Type __desired  = __expected < __val ? __expected : __val;
  while (__desired != __val && !__atomic_compare_exchange_n(__ptr, &__expected, __desired, __memorder, __memorder)) {
