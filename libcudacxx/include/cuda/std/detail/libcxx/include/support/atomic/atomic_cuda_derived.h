...
bool _LIBCUDACXX_DEVICE
__atomic_compare_exchange_cuda(_Type volatile* __ptr, _Type* __expected, const _Type* __desired, bool,
    int __success_memorder, int __failure_memorder, _Scope __s)
{
...
template <class _Type, class _Scope>
bool _LIBCUDACXX_DEVICE
__atomic_compare_exchange_n_cuda(_Type volatile* __ptr, _Type* __expected, _Type __desired, bool __weak,
    int __success_memorder, int __failure_memorder, _Scope __s)
{
...
__atomic_signal_fence_cuda(int)
{
  asm volatile("" ::: "memory");
}
