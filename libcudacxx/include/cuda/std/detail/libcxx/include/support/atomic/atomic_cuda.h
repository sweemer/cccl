...
inline _LIBCUDACXX_HOST_DEVICE int
__stronger_order_cuda(int __a, int __b)
{
...
__cxx_atomic_thread_fence(memory_order __order)
{
...
_LIBCUDACXX_INLINE_VISIBILITY inline void
__cxx_atomic_signal_fence(memory_order __order)
{
  NV_DISPATCH_TARGET(NV_IS_DEVICE,
...
constexpr _LIBCUDACXX_INLINE_VISIBILITY inline __cxx_atomic_small_to_32<_Tp>
...
template <class _Tp, __enable_if_t<is_arithmetic<_Tp>::value, int> = 0>
constexpr _LIBCUDACXX_INLINE_VISIBILITY inline _Tp
__cxx_small_from_32(__cxx_atomic_small_to_32<_Tp> __val)
{
...
template <class _Tp, __enable_if_t<!is_arithmetic<_Tp>::value, int> = 0>
_LIBCUDACXX_INLINE_VISIBILITY inline __cxx_atomic_small_to_32<_Tp>
__cxx_small_to_32(_Tp __val)
{
...
template <class _Tp, __enable_if_t<!is_arithmetic<_Tp>::value, int> = 0>
_LIBCUDACXX_INLINE_VISIBILITY inline _Tp
__cxx_small_from_32(__cxx_atomic_small_to_32<_Tp> __val)
{
  _Tp __temp{};
  memcpy(&__temp, &__val, sizeof(_Tp));
...
template <typename _Tp, int _Sco>
using __cxx_atomic_base_impl = __conditional_t<sizeof(_Tp) < 4, __cxx_atomic_base_small_impl<_Tp, _Sco>,
...
template <typename _Tp, int _Sco, bool _Ref>
_LIBCUDACXX_HOST_DEVICE bool
__cxx_atomic_compare_exchange_strong(__cxx_atomic_base_heterogeneous_impl<_Tp, _Sco, _Ref> volatile* __a,
    _Tp* __expected, _Tp __val, memory_order __success, memory_order __failure)
{
...
template <typename _Tp, int _Sco, bool _Ref>
_LIBCUDACXX_HOST_DEVICE bool
__cxx_atomic_compare_exchange_weak(__cxx_atomic_base_heterogeneous_impl<_Tp, _Sco, _Ref> volatile* __a, _Tp* __expected,
    _Tp __val, memory_order __success, memory_order __failure)
{
  alignas(_Tp) auto __tmp = *__expected;
  bool __result           = false;
  NV_DISPATCH_TARGET(NV_IS_DEVICE,
...
__cxx_atomic_init(__cxx_atomic_base_small_impl<_Tp, _Sco> volatile* __a, _Tp __val)
{
...
inline int
__cuda_memcmp(void const* __lhs, void const* __rhs, size_t __count)
{
  NV_DISPATCH_TARGET(NV_IS_DEVICE,
...
template <typename _Tp, int _Sco>
_LIBCUDACXX_HOST_DEVICE inline bool
__cxx_atomic_compare_exchange_weak(__cxx_atomic_base_small_impl<_Tp, _Sco> volatile* __a, _Tp* __expected, _Tp __value,
...
template <typename _Tp, int _Sco>
_LIBCUDACXX_HOST_DEVICE inline bool
__cxx_atomic_compare_exchange_strong(__cxx_atomic_base_small_impl<_Tp, _Sco> volatile* __a, _Tp* __expected,
