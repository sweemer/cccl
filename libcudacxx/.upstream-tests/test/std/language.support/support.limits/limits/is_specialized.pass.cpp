...
test()
{
  ...
  static_assert(
      cuda::std::numeric_limits<const T>::is_specialized, "cuda::std::numeric_limits<const T>::is_specialized");
  static_assert(
      cuda::std::numeric_limits<volatile T>::is_specialized, "cuda::std::numeric_limits<volatile T>::is_specialized");
