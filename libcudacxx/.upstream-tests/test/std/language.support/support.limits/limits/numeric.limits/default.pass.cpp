...
{
  static_assert(
      cuda::std::numeric_limits<A>::is_specialized == false, "cuda::std::numeric_limits<A>::is_specialized == false");
  ...
  static_assert(
      cuda::std::numeric_limits<A>::has_infinity == false, "cuda::std::numeric_limits<A>::has_infinity == false");
  static_assert(
      cuda::std::numeric_limits<A>::has_quiet_NaN == false, "cuda::std::numeric_limits<A>::has_quiet_NaN == false");
  ...
  static_assert(
      cuda::std::numeric_limits<A>::has_denorm_loss == false, "cuda::std::numeric_limits<A>::has_denorm_loss == false");
  ...
  static_assert(
      cuda::std::numeric_limits<A>::tinyness_before == false, "cuda::std::numeric_limits<A>::tinyness_before == false");
