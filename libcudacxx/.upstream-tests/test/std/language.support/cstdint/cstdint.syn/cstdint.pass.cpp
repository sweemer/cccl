...
main(int, char**)
{
  ...
  static_assert(
      cuda::std::is_unsigned<cuda::std::uint16_t>::value, "cuda::std::is_unsigned<cuda::std::uint16_t>::value");
  // typedef cuda::std::uint32_t
  static_assert(sizeof(cuda::std::uint32_t) * CHAR_BIT == 32, "sizeof(cuda::std::uint32_t)*CHAR_BIT == 32");
  static_assert(
      cuda::std::is_unsigned<cuda::std::uint32_t>::value, "cuda::std::is_unsigned<cuda::std::uint32_t>::value");
  // typedef cuda::std::uint64_t
  static_assert(sizeof(cuda::std::uint64_t) * CHAR_BIT == 64, "sizeof(cuda::std::uint64_t)*CHAR_BIT == 64");
  static_assert(
      cuda::std::is_unsigned<cuda::std::uint64_t>::value, "cuda::std::is_unsigned<cuda::std::uint64_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_least8_t>::value, "cuda::std::is_signed<cuda::std::int_least8_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_least16_t>::value, "cuda::std::is_signed<cuda::std::int_least16_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_least32_t>::value, "cuda::std::is_signed<cuda::std::int_least32_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_least64_t>::value, "cuda::std::is_signed<cuda::std::int_least64_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_fast8_t>::value, "cuda::std::is_signed<cuda::std::int_fast8_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_fast16_t>::value, "cuda::std::is_signed<cuda::std::int_fast16_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_fast32_t>::value, "cuda::std::is_signed<cuda::std::int_fast32_t>::value");
  ...
  static_assert(
      cuda::std::is_signed<cuda::std::int_fast64_t>::value, "cuda::std::is_signed<cuda::std::int_fast64_t>::value");
  ...
  static_assert(
      cuda::std::is_unsigned<cuda::std::uint_fast8_t>::value, "cuda::std::is_unsigned<cuda::std::uint_fast8_t>::value");
  ...
  static_assert(
      cuda::std::is_unsigned<cuda::std::uintptr_t>::value, "cuda::std::is_unsigned<cuda::std::uintptr_t>::value");
  ...
  static_assert(
      cuda::std::is_unsigned<cuda::std::uintmax_t>::value, "cuda::std::is_unsigned<cuda::std::uintmax_t>::value");
