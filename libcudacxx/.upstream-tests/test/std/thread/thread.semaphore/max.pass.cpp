...
main(int, char**)
{
  ...
  static_assert(
      cuda::counting_semaphore<cuda::thread_scope_system, cuda::std::numeric_limits<int>::max()>::max() >= 1, "");
  static_assert(
  ...
  static_assert(
      cuda::counting_semaphore<cuda::thread_scope_device, cuda::std::numeric_limits<int>::max()>::max() >= 1, "");
  static_assert(
  ...
  static_assert(
      cuda::counting_semaphore<cuda::thread_scope_block, cuda::std::numeric_limits<int>::max()>::max() >= 1, "");
  static_assert(
