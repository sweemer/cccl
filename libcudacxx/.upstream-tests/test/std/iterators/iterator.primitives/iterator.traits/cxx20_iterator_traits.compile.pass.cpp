...
struct MinusNotDeclaredIter
{
  ...
  operator==(const MinusNotDeclaredIter&, const MinusNotDeclaredIter&) noexcept
  {
    return true;
  }
  __host__ __device__ friend bool
...
#else
  __host__ __device__ friend bool
  operator==(const WrongSubscriptReturnType&, const WrongSubscriptReturnType&) noexcept
  {
    return true;
  }
  __host__ __device__ friend bool
