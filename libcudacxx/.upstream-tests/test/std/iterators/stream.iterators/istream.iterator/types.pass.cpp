...
#  if TEST_STD_VER <= 14
  static_assert(
      (cuda::std::is_convertible<I1,
          cuda::std::
              iterator<cuda::std::input_iterator_tag, double, cuda::std::ptrdiff_t, const double*, const double&> >::
              value),
      "");
#  else
...
#  if TEST_STD_VER <= 14
  static_assert(
      (cuda::std::is_convertible<I2,
          cuda::std::iterator<cuda::std::input_iterator_tag,
              unsigned,
              cuda::std::ptrdiff_t,
              const unsigned*,
