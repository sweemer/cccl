...
static_assert(cuda::std::indirect_strict_weak_order<CompDefault, cuda::std::projected<Foo*, ProjFooToInt>,
    cuda::std::projected<Foo*, ProjFooToLong>>);
static_assert(cuda::std::mergeable<Foo*, Foo*, Foo*, CompDefault, ProjFooToInt, ProjFooToLong>);
static_assert(cuda::std::indirect_strict_weak_order<CompInt, cuda::std::projected<Foo*, ProjFooToInt>,
    cuda::std::projected<Foo*, ProjFooToLong>>);
