...
struct HasIterSwap
{
  ...
  iter_swap(HasIterSwap& a, HasIterSwap& b)
  {
    a.value_ = 1;
    b.value_ = 1;
  }
  __host__ __device__ friend constexpr void
  iter_swap(HasIterSwap& a, int& b)
  {
    a.value_ = 2;
    b        = 2;
  }
...
{
  __host__ __device__ friend _LIBCUDACXX_NODISCARD_EXT int
  iter_swap(NodiscardIterSwap&, NodiscardIterSwap&)
  {
    return 0;
  }
};
...
ensureVoidCast(NodiscardIterSwap& a, NodiscardIterSwap& b)
{
...
struct HasRangesSwap
{
  ...
  __host__ __device__ friend constexpr void
  swap(HasRangesSwap& a, HasRangesSwap& b)
  {
    a.value_ = 1;
    b.value_ = 1;
  }
  __host__ __device__ friend constexpr void
  swap(HasRangesSwap& a, int& b)
  {
    a.value_ = 2;
    b        = 2;
  }
...
struct HasRangesSwapWrapper
{
  ...
  __host__ __device__ constexpr HasRangesSwap&
  operator*() const
  {
    return value_;
  }
...
{
  bool value = false;
  __host__ __device__ constexpr B&
  operator=(const A&)
  {
    value = true;
    return *this;
...
struct MoveOnly1
{
  ...
  __host__ __device__ constexpr MoveOnly1&
  operator=(MoveOnly2&&)
  {
    value = true;
    return *this;
...
struct MoveOnly2
{
  ...
  __host__ __device__ constexpr MoveOnly2&
  operator=(MoveOnly1&&)
  {
    value = true;
    return *this;
