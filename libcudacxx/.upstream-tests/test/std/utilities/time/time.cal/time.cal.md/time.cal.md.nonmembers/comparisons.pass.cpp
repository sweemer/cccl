...
main(int, char**)
{
  ...
  for (unsigned i = 1; i < 12; ++i) {
    for (unsigned j = 1; j < 12; ++j) {
      assert((testComparisons6(month_day{month{i}, day{1}}, month_day{month{j}, day{1}}, i == j, i < j)));
    }
  }
  ...
  for (unsigned i = 1; i < 31; ++i) {
    for (unsigned j = 1; j < 31; ++j) {
      assert((testComparisons6(month_day{month{2}, day{i}}, month_day{month{2}, day{j}}, i == j, i < j)));
    }
  }
