...
main(int, char**)
{
  ...
  static_assert(testComparisons2(year_month_weekday{year{1234}, January, weekday_indexed{Tuesday, 1}},
  ...
  static_assert(testComparisons2(year_month_weekday{year{1234}, February, weekday_indexed{Tuesday, 1}},
                    year_month_weekday{year{1235}, January, weekday_indexed{Tuesday, 1}},
                    false),
      "");

  //  different year and day
  static_assert(testComparisons2(year_month_weekday{year{1234}, January, weekday_indexed{Tuesday, 2}},
                    year_month_weekday{year{1235}, January, weekday_indexed{Tuesday, 1}},
                    false),
      "");

  //  different year, month and day
  static_assert(testComparisons2(year_month_weekday{year{1234}, February, weekday_indexed{Tuesday, 2}},
                    year_month_weekday{year{1235}, January, weekday_indexed{Tuesday, 1}},
                    false),
      "");
  ...
  for (unsigned i = 1; i < 28; ++i) {
    for (unsigned j = 1; j < 28; ++j) {
      assert((testComparisons2(year_month_weekday{year{1234}, January, weekday_indexed{Tuesday, i}},
  ...
  for (unsigned i = 1; i < 12; ++i) {
    for (unsigned j = 1; j < 12; ++j) {
      assert((testComparisons2(year_month_weekday{year{1234}, month{i}, weekday_indexed{Tuesday, 1}},
  ...
  for (int i = 1000; i < 20; ++i) {
    for (int j = 1000; j < 20; ++j) {
      assert((testComparisons2(year_month_weekday{year{i}, January, weekday_indexed{Tuesday, 1}},
