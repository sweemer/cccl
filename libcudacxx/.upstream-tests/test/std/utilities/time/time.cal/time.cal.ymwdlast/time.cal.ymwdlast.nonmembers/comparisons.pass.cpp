...
main(int, char**)
{
  ...
  static_assert(testComparisons2(year_month_weekday_last{year{1234}, January, weekday_last{Tuesday}},
  ...
  static_assert(testComparisons2(year_month_weekday_last{year{1234}, February, weekday_last{Tuesday}},
                    year_month_weekday_last{year{1235}, January, weekday_last{Tuesday}},
                    false),
      "");

  //  different year and day
  static_assert(testComparisons2(year_month_weekday_last{year{1234}, January, weekday_last{Wednesday}},
                    year_month_weekday_last{year{1235}, January, weekday_last{Tuesday}},
                    false),
      "");

  //  different year, month and day
  static_assert(testComparisons2(year_month_weekday_last{year{1234}, February, weekday_last{Wednesday}},
                    year_month_weekday_last{year{1235}, January, weekday_last{Tuesday}},
                    false),
      "");
  ...
  for (unsigned i = 1; i < 28; ++i) {
    for (unsigned j = 1; j < 28; ++j) {
      assert((testComparisons2(year_month_weekday_last{year{1234}, January, weekday_last{weekday{i}}},
  ...
  for (unsigned i = 1; i < 12; ++i) {
    for (unsigned j = 1; j < 12; ++j) {
      assert((testComparisons2(year_month_weekday_last{year{1234}, month{i}, weekday_last{Tuesday}},
  ...
  for (int i = 1000; i < 20; ++i) {
    for (int j = 1000; j < 20; ++j) {
      assert((testComparisons2(year_month_weekday_last{year{i}, January, weekday_last{Tuesday}},
