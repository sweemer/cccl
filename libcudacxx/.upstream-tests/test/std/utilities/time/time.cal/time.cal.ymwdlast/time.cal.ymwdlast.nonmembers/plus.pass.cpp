...
main(int, char**)
{
  ...
  { // year_month_weekday_last + months
    ...
    ASSERT_SAME_TYPE(
        year_month_weekday_last, decltype(cuda::std::declval<year_month_weekday_last>() + std::declval<months>()));
    ASSERT_SAME_TYPE(
        year_month_weekday_last, decltype(cuda::std::declval<months>() + std::declval<year_month_weekday_last>()));
  ...
  { // year_month_weekday_last + years
    ...
    ASSERT_SAME_TYPE(
        year_month_weekday_last, decltype(cuda::std::declval<year_month_weekday_last>() + std::declval<years>()));
    ASSERT_SAME_TYPE(
        year_month_weekday_last, decltype(cuda::std::declval<years>() + std::declval<year_month_weekday_last>()));
