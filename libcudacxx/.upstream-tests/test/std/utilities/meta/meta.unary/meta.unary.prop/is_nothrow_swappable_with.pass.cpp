...
main(int, char**)
{
  using namespace MyNS;
  {
    ...
    static_assert(
        cuda::std::is_swappable_with<A&, A&>::value && !cuda::std::is_nothrow_swappable_with<A&, A&>::value, "");
  }
  {
    ...
    static_assert(
        !cuda::std::is_nothrow_swappable_with<A&, C&>::value && cuda::std::is_swappable_with<A&, C&>::value, "");
