...
no_common_type_imp(int) -> always_bool<typename cuda::std::common_type<Args...>::type>
{
  return false;
}
...
test_bullet_three_one()
{
  ...
  // same.
  {
    ...
    static_assert(
        (cuda::std::is_same<cuda::std::common_type<T1, T1>::type, cuda::std::common_type<T1>::type>::value), "");
  }
  {
...
test_bullet_three_four()
{
  ...
  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<const bad_reference_wrapper<double>, double>, double>, "");
  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<volatile bad_reference_wrapper<double>, double>, double>, "");
  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<const volatile bad_reference_wrapper<double>, double>, double>, "");

  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<bad_reference_wrapper<double>, const double>, double>, "");
  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<bad_reference_wrapper<double>, volatile double>, double>, "");
  static_assert(
...
main(int, char**)
{
  ...
  static_assert(
      cuda::std::is_same<cuda::std::common_type<int, int, int, int, int, int, int, int>::type, int>::value, "");
