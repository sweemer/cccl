...
struct TracedBase
{
  ...
  __host__ __device__ constexpr TracedBase&
  operator=(const TracedBase& other) noexcept(copyMoveNoexcept)
  {
    data_                    = other.data_;
  ...
  __host__ __device__ constexpr TracedBase&
  operator=(TracedBase&& other) noexcept(copyMoveNoexcept)
  {
    data_                    = other.data_;
...
struct ADLSwap
{
  ...
  __host__ __device__ constexpr ADLSwap(int ii)
      : i(ii)
  {}
  __host__ __device__ constexpr friend void
  swap(ADLSwap& x, ADLSwap& y)
  {
...
struct TrackedMove
{
  ...
  __host__ __device__ constexpr friend void
  swap(TrackedMove& x, TrackedMove& y)
  {
    cuda::std::swap(x.i, y.i);
