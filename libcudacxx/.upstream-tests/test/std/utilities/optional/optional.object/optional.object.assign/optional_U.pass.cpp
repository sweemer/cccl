...
struct AssignableFrom
{
  ...
  __host__ __device__ AssignableFrom&
  operator=(T)
  {
    ++type_assigned();
    return *this;
...
test()
{
  ...
  public:
    ...
    __host__ __device__ constexpr StateTracker&
    operator=(StateTracker&& other) noexcept
    {
    ...
    __host__ __device__ constexpr StateTracker&
    operator=(StateTracker const& other) noexcept
    {
      *state_ = state_t::inactive;
      state_  = other.state_;
