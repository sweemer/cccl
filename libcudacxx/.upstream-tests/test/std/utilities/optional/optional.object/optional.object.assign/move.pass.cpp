...
#  endif // !(defined(TEST_COMPILER_CUDACC_BELOW_11_3) && defined(TEST_COMPILER_CLANG))
  ...
  }
  {
    struct ThrowsMove
    {
      ...
      {}
      __host__ __device__ ThrowsMove&
      operator=(ThrowsMove const&) noexcept
      {
        return *this;
      }
      __host__ __device__ ThrowsMove&
      operator=(ThrowsMove&&) noexcept
      {
        return *this;
      }
    };
    ...
    struct ThrowsMoveAssign
    {
      ...
      __host__ __device__ ThrowsMoveAssign&
      operator=(ThrowsMoveAssign&&) noexcept(false)
      {
        return *this;
      }
    };
    ...
    struct NoThrowMove
    {
      ...
      {}
      __host__ __device__ NoThrowMove&
      operator=(NoThrowMove const&) noexcept
      {
        return *this;
      }
      __host__ __device__ NoThrowMove&
      operator=(NoThrowMove&&) noexcept
      {
        return *this;
      }
    };
