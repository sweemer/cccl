...
#if TEST_STD_VER > 11
  NV_IF_TARGET(NV_IS_HOST, ({ // Test that std::ignore provides constexpr converting assignment.
...
main(int, char**)
{
  NV_IF_TARGET(NV_IS_HOST, (constexpr auto& ignore_v = cuda::std::ignore; unused(ignore_v);))
  {
