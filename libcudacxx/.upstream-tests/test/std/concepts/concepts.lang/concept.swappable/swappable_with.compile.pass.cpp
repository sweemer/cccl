...
static_assert(!check_swappable_with_including_lvalue_ref_to_volatile< int, int (S::*)()>(), "");
static_assert(
    check_swappable_with_including_lvalue_ref_to_volatile< int (S::*)() noexcept, int (S::*)() noexcept>(), "");
#if TEST_STD_VER > 17
...
#if TEST_STD_VER > 17
static_assert(
    !check_swappable_with_including_lvalue_ref_to_volatile< int (S::*)() const, int (S::*)() const noexcept>(), "");
#endif // TEST_STD_VER > 17
static_assert(
    check_swappable_with_including_lvalue_ref_to_volatile< int (S::*)() volatile, int (S::*)() volatile>(), "");
...
namespace adl {
    ...
    || TEST_STD_VER > 17 // MSVC ignores the rvalue/lvalue distinction in the swap definitions
...
struct swappable_with_const_s1_but_not_swappable
{
  ...
  __host__ __device__ swappable_with_const_s1_but_not_swappable(swappable_with_const_s1_but_not_swappable const&&);
  __host__ __device__ swappable_with_const_s1_but_not_swappable& operator=(
...
struct swappable_with_volatile_s1_but_not_swappable
{
  ...
  __host__ __device__ swappable_with_volatile_s1_but_not_swappable(
      swappable_with_volatile_s1_but_not_swappable volatile&&);
  __host__ __device__ swappable_with_volatile_s1_but_not_swappable& operator=(
      swappable_with_volatile_s1_but_not_swappable volatile&);
  __host__ __device__ swappable_with_volatile_s1_but_not_swappable& operator=(
      swappable_with_volatile_s1_but_not_swappable volatile&&);
...
struct swappable_with_cv_s1_but_not_swappable
{
  ...
  __host__ __device__ swappable_with_cv_s1_but_not_swappable(swappable_with_cv_s1_but_not_swappable const volatile&&);
  __host__ __device__ swappable_with_cv_s1_but_not_swappable& operator=(
...
struct swappable_with_rvalue_ref_to_s1_but_not_swappable
{
  __host__ __device__ friend void swap(
      swappable_with_rvalue_ref_to_s1_but_not_swappable&&, swappable_with_rvalue_ref_to_s1_but_not_swappable&&);
...
static_assert(
    !swappable_with< swappable_with_rvalue_ref_to_volatile_s1_but_not_swappable volatile&&, s1 volatile&&>, "");
...
struct swappable_with_rvalue_ref_to_cv_s1_but_not_swappable
{
  ...
  __host__ __device__ friend void swap(
      s1 const volatile&&, swappable_with_rvalue_ref_to_cv_s1_but_not_swappable const volatile&&);
  __host__ __device__ friend void swap(
      swappable_with_rvalue_ref_to_cv_s1_but_not_swappable const volatile&&, s1 const volatile&&);
...
struct swappable_with_rvalue_ref_to_const_s3
{
  ...
  __host__ __device__ friend void swap(
      swappable_with_rvalue_ref_to_const_s3 const&&, swappable_with_rvalue_ref_to_const_s3 const&&);
...
struct swappable_with_rvalue_ref_to_volatile_s3
{
  ...
  __host__ __device__ swappable_with_rvalue_ref_to_volatile_s3(swappable_with_rvalue_ref_to_volatile_s3 volatile&&);
  __host__ __device__ swappable_with_rvalue_ref_to_volatile_s3& operator=(
      swappable_with_rvalue_ref_to_volatile_s3 volatile&);
  __host__ __device__ swappable_with_rvalue_ref_to_volatile_s3& operator=(
      swappable_with_rvalue_ref_to_volatile_s3 volatile&&);

  __host__ __device__ friend void swap(
      swappable_with_rvalue_ref_to_volatile_s3 volatile&&, swappable_with_rvalue_ref_to_volatile_s3 volatile&&);
...
struct swappable_with_rvalue_ref_to_cv_s3
{
  ...
  __host__ __device__ swappable_with_rvalue_ref_to_cv_s3& operator=(
      swappable_with_rvalue_ref_to_cv_s3 const volatile&&);

  __host__ __device__ friend void swap(
      swappable_with_rvalue_ref_to_cv_s3 const volatile&&, swappable_with_rvalue_ref_to_cv_s3 const volatile&&);
...
struct Proxy
{
  ...
  swap(Proxy x, Proxy y)
  {
    cuda::std::ranges::swap(*x.a, *y.a);
  }
};
__host__ __device__ constexpr Proxy
proxy(A& a)
{
  return Proxy{a};
}
