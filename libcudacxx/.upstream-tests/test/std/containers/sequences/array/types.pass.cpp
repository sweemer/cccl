...
test_iterators()
{
  ...
  static_assert(
      (cuda::std::is_same<typename ItT::iterator_category, cuda::std::random_access_iterator_tag>::value), "");
  ...
  static_assert(
      (cuda::std::is_same<typename CItT::iterator_category, cuda::std::random_access_iterator_tag>::value), "");
