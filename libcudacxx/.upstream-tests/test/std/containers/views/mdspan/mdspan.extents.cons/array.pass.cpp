...
struct is_array_cons_avail< T, IndexType, N,
    cuda::std::enable_if_t<
        cuda::std::is_same< decltype(T{cuda::std::declval<cuda::std::array<IndexType, N>>()}), T >::value > >
    : cuda::std::true_type
{};
...
#  ifndef TEST_COMPILER_NVHPC
  static_assert(
      is_array_cons_avail_v< cuda::std::dextents< int, 1>, my_int_non_nothrow_constructible, 1 > == false, "");
