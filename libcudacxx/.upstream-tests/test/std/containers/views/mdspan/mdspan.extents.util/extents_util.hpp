...
using extents_test_types =
    cuda::std::tuple< cuda::std::tuple< _exts< 10 >, _sizes<> >, cuda::std::tuple< _exts<dyn >, _sizes<10 > >,
        cuda::std::tuple< _exts< 10, 3>, _sizes<> >, cuda::std::tuple< _exts<dyn, 3>, _sizes<10 > >,
        cuda::std::tuple< _exts< 10, dyn>, _sizes< 3 > >, cuda::std::tuple< _exts<dyn, dyn>, _sizes<10, 3> > >;
