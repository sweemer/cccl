...
test_constructibility()
{
  ...
  static_assert(
      !cuda::std::is_constructible<cuda::std::span<const int, Extent>, const volatile int*, size_t>::value, "");
  ...
  static_assert(!cuda::std::is_constructible<cuda::std::span<int, Extent>, double*, size_t>::value,
      ""); // iterator type differs from span type
  static_assert(!cuda::std::is_constructible<cuda::std::span<int, Extent>, size_t, size_t>::value, "");
  static_assert(
      !cuda::std::is_constructible<cuda::std::span<int, Extent>, Other*, size_t>::value, ""); // unrelated iterator type
