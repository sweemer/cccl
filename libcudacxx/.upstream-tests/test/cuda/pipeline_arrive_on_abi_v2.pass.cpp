...
template <typename T>
__device__ bool
arrive_on_test(char* global_buffer, size_t buffer_size)
{
...
__device__ void
arrive_on_nvrtc(size_t buffer_size)
{
...
template <typename T>
__global__ void
arrive_on_kernel(char* global_buffer, size_t buffer_size, bool* success)
{
