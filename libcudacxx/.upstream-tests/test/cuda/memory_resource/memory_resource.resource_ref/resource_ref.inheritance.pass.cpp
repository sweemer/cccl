...
struct resource_base
{
  ...
  bool
  operator==(const resource_base& other) const
  {
    return true;
  }
  bool
  ...
  friend void
  get_property(const resource_base&, Property) noexcept
  {}
...
struct resource_derived_first : public resource_base<Properties...>
{
  ...
  bool
  operator==(const resource_derived_first& other) const
  {
    return true;
  }
  bool
...
struct resource_derived_second : public resource_base<Properties...>
{
  ...
  bool
  operator==(const resource_derived_second& other) const
  {
    return true;
  }
  bool
...
template <class... Properties>
void
test_resource_ref_from_pointer()
{
  some_data input{1337};
  resource_derived_first<Properties...> first{42};
  resource_derived_second<Properties...> second{&input};
