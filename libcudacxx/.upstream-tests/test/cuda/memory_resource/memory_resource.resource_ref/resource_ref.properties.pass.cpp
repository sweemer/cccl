...
struct resource
{
  ...
  friend void
  get_property(const resource&, Property) noexcept
  {}
...
static_assert(
    sizeof(cuda::mr::resource_ref<property_with_value<short>, property_with_value<int> >) == (4 * sizeof(void*)), "");
static_assert(
    sizeof(cuda::mr::resource_ref<property_with_value<short>, property_without_value<int> >) == (3 * sizeof(void*)),
    "");
static_assert(
    sizeof(cuda::mr::resource_ref<property_without_value<short>, property_with_value<int> >) == (3 * sizeof(void*)),
    "");
static_assert(
    sizeof(cuda::mr::resource_ref<property_without_value<short>, property_without_value<int> >) == (2 * sizeof(void*)),
    "");
