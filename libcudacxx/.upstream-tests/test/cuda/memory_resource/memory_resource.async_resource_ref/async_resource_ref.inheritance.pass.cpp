...
struct async_resource_base
{
  ...
  bool
  operator==(const async_resource_base& other) const
  {
    return true;
  }
  bool
  ...
  friend void
  get_property(const async_resource_base&, Property) noexcept
  {}
...
struct async_resource_derived_first : public async_resource_base<Properties...>
{
  ...
  void*
  allocate(std::size_t, std::size_t) override
  {
    return &_val;
  }

  void
  deallocate(void* ptr, std::size_t, std::size_t) override
  {}

  void*
  allocate_async(std::size_t, std::size_t, cuda::stream_ref) override
  {
    return &_val;
  }

  void
  deallocate_async(void* ptr, std::size_t, std::size_t, cuda::stream_ref) override
  {}

  bool
  operator==(const async_resource_derived_first& other) const
  {
    return true;
  }
  bool
...
struct async_resource_derived_second : public async_resource_base<Properties...>
{
  ...
  bool
  operator==(const async_resource_derived_second& other) const
  {
    return true;
  }
  bool
