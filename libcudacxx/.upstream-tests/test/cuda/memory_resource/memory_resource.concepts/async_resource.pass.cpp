...
struct valid_resource
{
  ...
  {}
  bool
  operator==(const valid_resource&) const
  {
    return true;
  }
  bool
...
struct invalid_allocate_missing
{
  ...
  {}
  bool
  operator==(const invalid_allocate_missing&) const
  {
    return true;
  }
  bool
...
struct invalid_allocate_async_argument
{
  ...
  {}
  void*
  allocate_async(invalid_argument, std::size_t)
  {
    return nullptr;
  }
  void
  ...
  {}
  bool
  operator==(const invalid_allocate_async_argument&) const
  {
    return true;
  }
  bool
...
struct invalid_allocate_async_return
{
  ...
  {}
  bool
  operator==(const invalid_allocate_async_return&) const
  {
    return true;
  }
  bool
...
struct invalid_deallocate_async_argument
{
  ...
  void
  deallocate_async(void*, invalid_argument, std::size_t)
  {}
  bool
  operator==(const invalid_deallocate_async_argument&) const
  {
    return true;
  }
  bool
...
struct non_eq_comparable
{
  ...
  {}
  bool
  operator!=(const non_eq_comparable&) const
  {
    return false;
  }
};
...
struct non_neq_comparable
{
  ...
  {}
  bool
  operator==(const non_neq_comparable&) const
  {
    return true;
  }
};
