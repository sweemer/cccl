...
struct valid_resource_with_property
{
  ...
  void
  deallocate(void*, std::size_t, std::size_t)
  {}
  void*
  ...
  void
  deallocate_async(void*, std::size_t, std::size_t, cuda::stream_ref)
  {}
  bool
  operator==(const valid_resource_with_property&) const
  {
    return true;
  }
  bool
  ...
  friend void
  get_property(const valid_resource_with_property&, prop_with_value)
  {}
};
...
struct valid_resource_without_property
{
  ...
  {}
  bool
  operator==(const valid_resource_without_property&) const
  {
    return true;
  }
  bool
...
{
  friend void
  get_property(const invalid_resource_with_property&, prop_with_value)
  {}
};
...
struct resource_with_many_properties
{
  ...
  {}
  bool
  operator==(const resource_with_many_properties&) const
  {
    return true;
  }
  bool
  ...
  friend void
  get_property(const resource_with_many_properties&, prop_with_value)
  {}
  friend void
  get_property(const resource_with_many_properties&, prop)
  {}
};
...
{
  friend void
  get_property(const derived_with_property&, prop_with_value)
  {}
};
