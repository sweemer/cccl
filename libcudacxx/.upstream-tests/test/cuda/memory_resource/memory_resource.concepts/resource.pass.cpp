...
{
  void*
  allocate(invalid_argument, std::size_t)
  {
    return nullptr;
  }
  void
  ...
  {}
  bool
  operator==(const invalid_allocate_argument&)
  {
    return true;
  }
  bool
...
struct invalid_allocate_return
{
  ...
  {}
  bool
  operator==(const invalid_allocate_return&)
  {
    return true;
  }
  bool
...
struct invalid_deallocate_argument
{
  ...
  void
  deallocate(void*, invalid_argument, std::size_t)
  {}
  bool
  operator==(const invalid_deallocate_argument&)
  {
    return true;
  }
  bool
...
struct non_neq_comparable
{
  ...
  {}
  bool
  operator==(const non_neq_comparable&)
  {
    return true;
  }
};
