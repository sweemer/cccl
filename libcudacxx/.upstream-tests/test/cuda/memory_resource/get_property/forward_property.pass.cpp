...
struct upstream_with_valueless_property
{
  ...
  get_property(const upstream_with_valueless_property&, prop)
  {}
};
...
struct upstream_with_stateful_property
{
  ...
  get_property(const upstream_with_stateful_property&, prop_with_value)
  {
    return 42;
  }
};
...
{
  friend constexpr void
  get_property(const upstream_with_both_properties&, prop)
  {}
  friend constexpr int
  get_property(const upstream_with_both_properties&, prop_with_value)
  {
    return 42;
  }
};
...
{
  constexpr upstream_with_both_properties
  upstream_resource() const noexcept
  {
  ...
  get_property(const derived_override&, prop_with_value)
  {
    return 1337;
  }
};
...
{
  constexpr convertible_to_upstream
  upstream_resource() const noexcept
  {
