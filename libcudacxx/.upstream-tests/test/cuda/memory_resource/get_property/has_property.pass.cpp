...
{
  friend void
  get_property(const valid_property&, prop)
  {}
};
...
{
  friend int
  get_property(const valid_property_with_value&, prop_with_value)
  {
    return 42;
  }
};
...
{
  friend int
  get_property(const derived_from_property&, prop_with_value)
  {
    return 42;
  }
};
