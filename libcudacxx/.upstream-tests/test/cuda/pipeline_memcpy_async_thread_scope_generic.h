...
__host__ __device__ cuda::pipeline<scope>
get_pipeline(cuda::pipeline_shared_state<scope, PipelineStages>* pipe_state)
{
...
template < cuda::thread_scope Scope, class T, template <typename, typename> class SourceSelector,
    template <typename, typename> class DestSelector, template <typename, typename> class PipelineSelector,
