...
main(int, char**)
{
  ...
  {
    x.load(
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    x.load(
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    vx.load(
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    vx.load(
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
  ...
  {
    cuda::std::atomic_load_explicit(&x,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_load_explicit(&x,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_load_explicit(&vx,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_load_explicit(&vx,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    // valid memory orders
  ...
  {
    x.store(42,
        cuda::std::memory_order_consume); // expected-warning {{memory order argument to atomic operation is invalid}}
    x.store(42,
        cuda::std::memory_order_acquire); // expected-warning {{memory order argument to atomic operation is invalid}}
    x.store(42,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    vx.store(42,
        cuda::std::memory_order_consume); // expected-warning {{memory order argument to atomic operation is invalid}}
  ...
  {
    cuda::std::atomic_store_explicit(&x,
        42,
        cuda::std::memory_order_consume); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_store_explicit(&x,
        42,
    ...
    cuda::std::atomic_store_explicit(&x,
        42,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_store_explicit(&vx,
        42,
        cuda::std::memory_order_consume); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_store_explicit(&vx,
        42,
  ...
  {
    cuda::std::atomic_compare_exchange_weak_explicit(&x,
        &val1,
        val2,
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_weak_explicit(&x,
        ...
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_weak_explicit(&vx,
        &val1,
        val2,
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
  ...
  {
    x.compare_exchange_strong(val1,
        val2,
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    x.compare_exchange_strong(val1,
        ...
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    vx.compare_exchange_strong(val1,
        val2,
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    vx.compare_exchange_strong(val1,
  ...
  {
    cuda::std::atomic_compare_exchange_strong_explicit(&x,
        &val1,
        val2,
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_strong_explicit(&x,
        ...
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_strong_explicit(&vx,
        &val1,
        val2,
        cuda::std::memory_order_seq_cst,
        cuda::std::memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
