...
struct friend_three_way_comparable
{
  __host__ __device__ friend auto operator<=>(
      friend_three_way_comparable const&, friend_three_way_comparable const&) = default;
};
#    endif // !__NVCC__
#  endif // TEST_HAS_NO_SPACESHIP_OPERATOR
...
struct cxx20_friend_eq_operator_with_deleted_ne
{
  __host__ __device__ friend bool operator==(
      cxx20_friend_eq_operator_with_deleted_ne const&, cxx20_friend_eq_operator_with_deleted_ne const&) = default;
  __host__ __device__ friend bool operator!=(
      cxx20_friend_eq_operator_with_deleted_ne const&, cxx20_friend_eq_operator_with_deleted_ne const&) = delete;
};
...
{
  __host__ __device__ friend auto operator<=>(
      friend_three_way_comparable_with_deleted_eq const&, friend_three_way_comparable_with_deleted_eq const&) = default;
  __host__ __device__ friend bool operator==(
      friend_three_way_comparable_with_deleted_eq const&, friend_three_way_comparable_with_deleted_eq const&) = delete;
};
...
{
  __host__ __device__ friend auto operator<=>(
      friend_three_way_comparable_with_deleted_ne const&, friend_three_way_comparable_with_deleted_ne const&) = default;
  __host__ __device__ friend bool operator!=(
      friend_three_way_comparable_with_deleted_ne const&, friend_three_way_comparable_with_deleted_ne const&) = delete;
};
#    endif // !__NVCC__
#  endif // TEST_HAS_NO_SPACESHIP_OPERATOR
