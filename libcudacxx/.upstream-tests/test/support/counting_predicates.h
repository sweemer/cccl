...
public:
  ...
  __host__ __device__
  unary_counting_predicate(Predicate p)
      : p_(p)
      , count_(0)
  {}
  __host__ __device__ ~unary_counting_predicate() {}
...
public:
  ...
  binary_counting_predicate(Predicate p)
      ...
      , count_(0)
  {}
  __host__ __device__ ~binary_counting_predicate() {}

  __host__ __device__ bool
  operator()(const Arg1& a1, const Arg2& a2) const
  {
    ++count_;
    return p_(a1, a2);
  }
