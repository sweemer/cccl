...
{
  friend bool
  operator==(TypeID const& LHS, TypeID const& RHS)
  {
...
inline bool
operator==(TypeInfo<L> const&, TypeInfo<R> const&)
{
...
template <class L, class R>
inline bool
operator!=(TypeInfo<L> const& lhs, TypeInfo<R> const& rhs)
{
  return !(lhs == rhs);
}
...
struct AllocatorConstructController
{
  ...
  void
  expect(detail::TypeID const& tid)
  {
    assert(!unchecked());
    m_expected_args = &tid;
  }
  ...
  bool
  isInAllocatorConstruct() const
  {
    return m_allow_constructions;
  }

  void
  inAllocatorConstruct(bool value = true)
  {
    m_allow_constructions = value;
  }

  void
  allowUnchecked(bool value = true)
  {
...
public:
  ...
  friend bool
  operator==(ContainerTestAllocator, ContainerTestAllocator)
  {
    return true;
  }
  friend bool
  operator!=(ContainerTestAllocator x, ContainerTestAllocator y)
  {
    return !(x == y);
  }
};
...
template <int ID>
bool
operator==(CopyInsertable<ID> const& L, CopyInsertable<ID> const& R)
{
