...
public:
  ...
  iterator
  insert(const_iterator pos, size_type n, const value_type& x)
  {
...
template <class T>
bool
operator==(const nasty_vector<T>& x, const nasty_vector<T>& y)
{
  return x.v_ == y.v_;
}
...
public:
  ...
  void
  assign(size_type n, const value_type& t)
  {
    l_.assign(n, t);
  }
  void
  ...
  iterator
  erase(const_iterator pos, const_iterator last)
  {
  ...
  void
  resize(size_type, const value_type& c)
  {
    l_.resize(c);
  }
...
template <class T>
bool
operator==(const nasty_list<T>& x, const nasty_list<T>& y)
{
  return x.l_ == y.l_;
}
...
public:
  ...
  {}
  bool
  try_lock() TEST_NOEXCEPT
  {
    return true;
  }
  void
  unlock() TEST_NOEXCEPT
  {}
