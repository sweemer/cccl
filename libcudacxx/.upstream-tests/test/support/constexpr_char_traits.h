...
struct constexpr_char_traits
{
  ...
  static TEST_CONSTEXPR_CXX14 void
  assign(char_type& __c1, const char_type& __c2) TEST_NOEXCEPT
  {
    __c1 = __c2;
  }

  static TEST_CONSTEXPR bool
  eq(char_type __c1, char_type __c2) TEST_NOEXCEPT
  {
    return __c1 == __c2;
  }

  static TEST_CONSTEXPR bool
  lt(char_type __c1, char_type __c2) TEST_NOEXCEPT
  {
    return __c1 < __c2;
  }
  ...
  static TEST_CONSTEXPR int_type
  not_eof(int_type __c) TEST_NOEXCEPT
  {
    return eq_int_type(__c, eof()) ? ~eof() : __c;
  }

  static TEST_CONSTEXPR char_type
  to_char_type(int_type __c) TEST_NOEXCEPT
  {
    return char_type(__c);
  }

  static TEST_CONSTEXPR int_type
  to_int_type(char_type __c) TEST_NOEXCEPT
  {
    return int_type(__c);
  }

  static TEST_CONSTEXPR bool
  eq_int_type(int_type __c1, int_type __c2) TEST_NOEXCEPT
  {
    return __c1 == __c2;
  }
