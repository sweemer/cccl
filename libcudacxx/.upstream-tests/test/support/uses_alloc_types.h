...
inline bool
CompareVerbose(const char* LHSString, UsesAllocatorType LHS, const char* RHSString, UsesAllocatorType RHS)
{
  if (LHS == RHS) {
    return true;
  }
...
bool
checkConstruct(TestType& value, UsesAllocatorType form, typename TestType::CtorAlloc const& alloc)
...
template <class... ArgTypes, class TestType>
bool
checkConstruct(TestType& value, UsesAllocatorType form)
{
  return value.template checkConstruct<ArgTypes&&...>(form);
}
...
bool
checkConstructionEquiv(TestType& T, TestType& U)
...
public:
  ...
  bool
  checkConstruct(UsesAllocatorType expectType) const
  {
  ...
  template <class... ArgTypes>
  bool
  checkConstruct(UsesAllocatorType expectType, CtorAlloc const& expectAlloc) const
  {
  ...
  bool
  checkConstructEquiv(UsesAllocatorTestBase& O) const
  {
...
private:
  ...
  static CtorAlloc
  getAllocatorFromPack(ArgumentListID<LArgs...>, Args&&... args)
  {
  ...
  static CtorAlloc
  getAllocatorFromPackImp(typename detail::Identity<LArgs>::type..., CtorAlloc const& alloc)
  {
    return alloc;
  }
