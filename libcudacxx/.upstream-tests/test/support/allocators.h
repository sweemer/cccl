...
public:
  ...
  __device__ __host__ static cuda::std::pair<T*, cuda::std::size_t>&
  deallocate_called()
  {
  ...
  __device__ __host__
  A1(const A1& a) TEST_NOEXCEPT : id_(a.id())
  {
    copy_called() = true;
  }
  __device__ __host__
  A1(A1&& a) TEST_NOEXCEPT : id_(a.id())
  {
    move_called() = true;
  }
  __device__ __host__ A1&
  operator=(const A1& a) TEST_NOEXCEPT
  {
    id_           = a.id();
    copy_called() = true;
    return *this;
  ...
  template <class U>
  __device__ __host__
  A1(const A1<U>& a) TEST_NOEXCEPT : id_(a.id())
  {
    copy_called() = true;
  }
  template <class U>
  __device__ __host__
  A1(A1<U>&& a) TEST_NOEXCEPT : id_(a.id())
  {
    move_called() = true;
  }

  __device__ __host__ T*
  allocate(cuda::std::size_t n)
  {
  ...
  __device__ __host__ cuda::std::size_t
  max_size() const
  {
    return id_;
  }
...
operator==(const A1<T>& x, const A1<U>& y)
{
  return x.id() == y.id();
}
...
public:
  ...
  __device__ __host__
  A2(const A2& a) TEST_NOEXCEPT : id_(a.id())
  {
    copy_called() = true;
  }
  __device__ __host__
  A2(A2&& a) TEST_NOEXCEPT : id_(a.id())
  {
    move_called() = true;
  }
  __device__ __host__ A2&
  operator=(const A2& a) TEST_NOEXCEPT
  {
    id_           = a.id();
    copy_called() = true;
    return *this;
  ...
  __device__ __host__ T*
  allocate(cuda::std::size_t, const void* hint)
  {
    allocate_called() = true;
...
public:
  ...
  __device__ __host__
  A3(const A3& a) TEST_NOEXCEPT : id_(a.id())
  {
    copy_called() = true;
  }
  __device__ __host__
  A3(A3&& a) TEST_NOEXCEPT : id_(a.id())
  {
    move_called() = true;
  }
  __device__ __host__ A3&
  operator=(const A3& a) TEST_NOEXCEPT
  {
    id_           = a.id();
    copy_called() = true;
    return *this;
...
template <class T, class U>
inline __device__ __host__ bool
operator==(const A3<T>& x, const A3<U>& y)
{
  return x.id() == y.id();
}
