...
public:
  ...
  friend bool
  operator==(bare_allocator, bare_allocator)
  {
    return true;
  }
  friend bool
  operator!=(bare_allocator x, bare_allocator y)
  {
    return !(x == y);
  }
};
...
public:
  ...
  friend bool
  operator==(no_default_allocator, no_default_allocator)
  {
    return true;
  }
  friend bool
  operator!=(no_default_allocator x, no_default_allocator y)
  {
    return !(x == y);
  }
};
...
public:
  ...
  friend bool
  operator==(malloc_allocator, malloc_allocator)
  {
    return true;
  }
  friend bool
  operator!=(malloc_allocator x, malloc_allocator y)
  {
    return !(x == y);
  }
};
...
struct cpp03_overload_allocator : bare_allocator<T>
{
  ...
  void
  construct(pointer p, const value_type& val, std::true_type)
  {
    ::new (p) value_type(val);
    construct_called = true;
  }
  void
  construct(pointer p, const value_type& val, std::false_type)
  {
    ::new (p) value_type(val);
    construct_called = true;
  }
...
public:
  ...
  friend bool
  operator==(min_pointer x, min_pointer y)
  {
...
public:
  ...
  friend min_pointer
  operator+(difference_type n, min_pointer x)
  {
    return x + n;
  }
...
public:
  ...
  min_pointer(min_pointer<T, ID> p)
      : ptr_(p.ptr_)
  {}
  explicit min_pointer(min_pointer<const void, ID> p)
...
public:
  ...
  void
  deallocate(pointer p, std::ptrdiff_t)
  {
    return ::operator delete(p.ptr_);
  }

  friend bool
  operator==(min_allocator, min_allocator)
  {
    return true;
  }
  friend bool
  operator!=(min_allocator x, min_allocator y)
  {
    return !(x == y);
  }
};
...
public:
  ...
  friend bool
  operator!=(explicit_allocator x, explicit_allocator y)
  {
    return !(x == y);
  }
};
