...
public:
  ...
  bool
  checkAlloc(void* p, std::size_t s, std::size_t a) const
  {
    return C.checkAlloc(p, s, a);
  }

  bool
  checkDealloc(void* p, std::size_t s, std::size_t a) const
  {
...
protected:
  virtual void*
  do_allocate(std::size_t s, std::size_t a)
  {
    if (C.throw_on_alloc) {
  ...
  virtual void
  do_deallocate(void* p, std::size_t s, std::size_t a)
  {
...
struct NewDeleteProvider
{
  NewDeleteProvider() {}
  void*
  allocate(size_t s, size_t)
  {
    return ::operator new(s);
  }
  void
  deallocate(void* p, size_t, size_t)
  {
    ::operator delete(p);
  }
  void
