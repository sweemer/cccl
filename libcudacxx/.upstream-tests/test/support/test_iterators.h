...
public:
  ...
  template <class U, class T,
      class = typename cuda::std::enable_if<cuda::std::is_default_constructible<U>::value>::type>
  __host__ __device__ TEST_CONSTEXPR_CXX14
...
public:
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX14 forward_iterator&
  operator++()
  {
    ++it_;
    return *this;
...
public:
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX14 It
  base() const
  {
    return it_;
  }
  ...
  __host__ __device__ TEST_CONSTEXPR pointer
  operator->() const
  {
    return it_;
  }
...
public:
  ...
  __host__ __device__ constexpr It
  base() const
  {
    return it_;
  }
  ...
  __host__ __device__ constexpr reference
  operator*() const
  {
    return *it_;
  }
  __host__ __device__ constexpr pointer
  operator->() const
  {
    return it_;
  }
...
__host__ __device__ TEST_CONSTEXPR Iter
base(Iter i)
{
  return i;
}
...
struct NonThrowingIterator
{
  ...
  operator==(const NonThrowingIterator& a, const NonThrowingIterator& b) TEST_NOEXCEPT
  {
    bool atEndL = a.current_ == a.end_;
    bool atEndR = b.current_ == b.end_;
    if (atEndL != atEndR) {
...
#  endif // !TEST_COMPILER_MSVC_2017
  ...
  __host__ __device__ constexpr cpp20_input_iterator&
  operator++()
  {
    ++it_;
    return *this;
  ...
  __host__ __device__ friend constexpr It
  base(const cpp20_input_iterator& i)
  {
    return i.it_;
  }
...
#  endif // !TEST_COMPILER_MSVC_2017
  ...
  __host__ __device__ constexpr cpp20_output_iterator&
  operator++()
  {
    ++it_;
    return *this;
  ...
  __host__ __device__ friend constexpr It
  base(const cpp20_output_iterator& i)
  {
    return i.it_;
  }
...
#  endif
  ...
  __host__ __device__ constexpr difference_type
  stride_count() const
  {
...
public:
  ...
  {}
  __host__ __device__ friend constexpr bool
  operator==(const sized_sentinel& s, const It& i)
  {
    return s.base_ == base(i);
  }
#  if TEST_STD_VER < 20
...
public:
  ...
  __host__ __device__ static constexpr Iterator
  TrackMoves(int* p, int& iter_moves)
  {
  ...
  __host__ __device__ static constexpr Iterator
  TrackSwaps(int* p, int& iter_swaps)
  {
  ...
  __host__ __device__ constexpr value_type&
  operator*() const
  {
    return *ptr_;
  }
  ...
  __host__ __device__ friend constexpr Iterator
  ...
  __host__ __device__ constexpr Iterator
  operator-(difference_type n) const
  {
  ...
  __host__ __device__ constexpr friend value_type&&
...
#  ifndef TEST_HAS_NO_SPACESHIP_OPERATOR
  __host__ __device__ constexpr friend auto
  operator<=>(const Iterator& lhs, const Iterator& rhs)
  {
    return lhs.ptr_ <=> rhs.ptr_;
  }
...
#  endif // TEST_COMPILER_MSVC
  ...
  _LIBCUDACXX_REQUIRES((IsProxy<cuda::std::decay_t<Other>>
                        && cuda::std::assignable_from<const cuda::std::__add_lvalue_reference_t<T>,
                            decltype(cuda::std::declval<Other>().getData())>) )
  __host__ __device__ constexpr const Proxy&
...
#  endif // TEST_STD_VER > 17
  ...
  __host__ __device__ friend constexpr bool
  operator==(const Proxy& lhs, const Proxy<U>& rhs)
  {
    return lhs.data == rhs.data;
  }
...
#  endif // TEST_STD_VER > 17
  ...
  __host__ __device__ constexpr ProxyIterator&
  operator++()
  {
    ++base_;
    return *this;
