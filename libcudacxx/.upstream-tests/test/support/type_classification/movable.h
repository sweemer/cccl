...
{
  __host__ __device__ const_move_assign_and_traditional_move_assign& operator=(
      const_move_assign_and_traditional_move_assign&&);
  __host__ __device__ const_move_assign_and_traditional_move_assign& operator=(
      const_move_assign_and_traditional_move_assign&&) const;
};

struct volatile_move_assign_and_traditional_move_assign
{
  __host__ __device__ volatile_move_assign_and_traditional_move_assign& operator=(
      volatile_move_assign_and_traditional_move_assign&&);
  __host__ __device__ volatile_move_assign_and_traditional_move_assign& operator=(
      volatile_move_assign_and_traditional_move_assign&&) volatile;
};

struct cv_move_assign_and_traditional_move_assign
{
  __host__ __device__ cv_move_assign_and_traditional_move_assign& operator=(
      cv_move_assign_and_traditional_move_assign&&);
  __host__ __device__ cv_move_assign_and_traditional_move_assign& operator=(
      cv_move_assign_and_traditional_move_assign&&) const volatile;
};
...
struct deleted_assignment_from_const_rvalue
{
  ...
  __host__ __device__ deleted_assignment_from_const_rvalue& operator=(
      const deleted_assignment_from_const_rvalue&&) = delete;
};
