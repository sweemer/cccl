...
using testers = tester_list< assign_tester<nullopt_generator>, assign_tester<int_generator<123>>,
    assign_tester<nullopt_generator>, swap_tester<int_generator<17>>, reset_tester, assign_tester<int_generator<31>>,
...
struct non_trivial
{
  ...
  operator==(non_trivial lhs, non_trivial rhs)
  {
    return lhs.i == rhs.i;
  }
};
